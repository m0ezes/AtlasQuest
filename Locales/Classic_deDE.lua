...
local AQ_OR  = GREY.." oder|r "
local AQ_AND = GREY.." und|r "
local onlyHeroic  = "Diese Quest kann nur auf dem Schwierigkeitsgrad 'Heroisch' abgeschlossen werden."
local dailyQuest  = "Eine von vielen wiederholbaren Tagesquests, die bei diesem NPC verfügbar sein können (zufällig). Kann auf jedem Schwierigkeitsgrad abgeschlossen werden."
...
-- Options
L["ShowAtlasQuestWithAtlas"] = "Zeige AtlasQuest-Panel, wenn Atlas geöffnet wird";
...
L["ResetQuests"] = "Quest-Status zurücksetzen";
...
-- Vanilla Instances
if isClassic then
	L["Instance_1_Name"]  = "Blackrocktiefen"
	L["Instance_3_Name"]  = "Untere Blackrockspitze"
	L["Instance_4_Name"]  = "Obere Blackrockspitze"
	...
	L["Instance_3_Name"]  = "Untere Schwarzfelsspitze"
	L["Instance_4_Name"]  = "Obere Schwarzfelsspitze"
	L["Instance_12_Name"] = "Burg Schattenfang"
	L["Instance_17_Name"] = "Tiefschwarze Grotte"
	L["Instance_22_Name"] = "Der Flammenschlund"
	L["Instance_23_Name"] = "Hügel der Klingenhauer"
	L["Instance_24_Name"] = "Kral der Klingenhauer"
end

L["Instance_2_Name"]  = "Pechschwingenhort"
L["Instance_5_Name"]  = "Die Todesminen"
L["Instance_6_Name"]  = "Gnomeregan";
L["Instance_7_Name"]  = "SK: Bibliothek"
L["Instance_8_Name"]  = "SK: Waffenkammer"
L["Instance_9_Name"]  = "SK: Kathedrale"
L["Instance_10_Name"] = "SK: Friedhof"
L["Instance_11_Name"] = "Scholomance";
L["Instance_13_Name"] = "Das Verlies";
L["Instance_14_Name"] = "Stratholme";
L["Instance_15_Name"] = "Versunkener Tempel";
...
L["Instance_36_Name"] = "Drachen der Alpträume";  -- Atlas_OutdoorRaids
L["Instance_37_Name"] = "Azuregos";  -- Atlas_OutdoorRaids
L["Instance_38_Name"] = "Highlord Kruul";  -- Atlas_OutdoorRaids
...
L["Instance_60_Name"] = "Auge des Sturms";  -- Atlas_Battlegrounds
L["Instance_65_Name"] = "Skettis";  -- Atlas_OutdoorRaids
...
L["Quest_4136_Location"] = "Yuka Screwspigot (Brennende Steppe - Flammenkamm; "..YELLOW.."66.0, 22.0"..PREV..")";
L["Quest_4136_Note"] = "Du bekommst die Vorquest von Yorba Screwspigot (Tanaris - Steamwheedle Port; "..YELLOW.."67.0, 24.0"..PREV..").\nRibbly Screwspigot ist bei "..YELLOW.."[15]"..PREV..".";
L["Quest_4136_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4201_Location"] = "Herrin Nagmara (Schwarzfelstiefen; "..YELLOW.."[15]"..PREV..")";
L["Quest_4201_Note"] = "Die Riesensilbervene bekommst Du von den Giganten in Azshara.  Gromsblut kann per Kräuterkundler gefunden werden oder über das Aktionshaus gekauft werden.  Die Phliloe wird befüllt in (Un'Goro - Golakka-Krater; "..YELLOW.."31.0, 50.0"..PREV..").\nNach beendigung der Quest, kannst Du die Hintertür benutzen um die Phalanx zu töten.";
L["Quest_4201_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_4126_Location"] = "Ragnar Donnerbräu (Dun Morogh - Kharanos; "..YELLOW.."46.8, 52.4"..PREV..")";
L["Quest_4126_Note"] = "Die Vorquest startet bei Enohar Donnerbräu (Verlorene Lande - Burg Nethergarde; "..YELLOW.."63.6, 20.4"..PREV..").\nDu bekommst das Rezept von einen der Wachen, die erscheinen, wenn Du die Bierfässer zerstörst im Grimmigen Säufer bei "..YELLOW.."[15]"..PREV..".";
L["Quest_4126_RewardText"] = WHITE.."1(x10)"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_4262_Location"] = "Jalinda Sprig (Brennede Steppe - Morgan's Vigil; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4262_Note"] = "Übermeister Pyron ist ein Feuerelementar außerhalb der Dungeon.  Er patroulliert in der Nähe von "..YELLOW.."[24]"..PREV.." auf der Karte von den Schwarzfelstiefen bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_4263_Location"] = "Jalinda Sprig (Brennede Steppe - Morgan's Vigil; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4263_Note"] = "Lord Incendius befindet sich beim Schwarzen Amboss bei "..YELLOW.."[10]"..PREV..".";
L["Quest_4263_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_4123_Location"] = "Maxwort Uberglint (Brennende Steppe - Flammenkamm; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4123_Note"] = "Du kannst das Herz des Berges bei "..YELLOW.."[8]"..PREV.." in einer Truhe finden.  Um den Schlüssel zu diesem Tresor zu erhalten, musst Du erst die anderen kleineren Tresore mit dem Relikttruhenschlüsseln öffnen, die in der gesamten Dungeon verteilt sind.  Wenn alle kleinen Truhen geöffnet sind, erscheint Wachmann Stahlgriff und seine Freunde.  Besiege diese um den Schlüssel zu bekommen.";
...
L["Quest_4286_Location"] = "Oralius (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.6"..PREV..")";
...
L["Quest_4024_Location"] = "Cyrus Therepentous (Brennende Steppe - Slither Rock; "..YELLOW.."94.8, 31.6"..PREV..")";
L["Quest_4024_Note"] = "Die Questreihe staret bei Kalaran Windblade (Sengende Schlucht; "..YELLOW.."39.0, 38.8"..PREV..").\nBael'Gar ist bei "..YELLOW.."[11]"..PREV..".  Benutzt die veränderte Haut des schwarzen DrachenschwarmsUauf auf Bael'Gars Überreste um die Quest abzuschließen.";
L["Quest_4024_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4341_Location"] = "König Magni Bronzebeard (Ironforge; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4341_Note"] = "Die Vorquest startet bei der königliche Historikerin Archesonus (Ironforge; "..YELLOW.."38.6, 55.4"..PREV..").  Kharan Mighthammer ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_4362_Location"] = "König Magni Bronzebeard (Ironforge; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4362_Note"] = "Prinzessin Moira Bronzebeard ist bei "..YELLOW.."[21]"..PREV..".  Du musst Imperator Dagran Thaurissan besiegen und die Prinzessin muss überleben um diese Quest abschließen zu können.  Die Prinzessin schickt dich zurück zu König Magni Bronzebeard in Ironforge für deine Belohnung.";
L["Quest_4362_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7848_Location"] = "Lothos Riftwaker (Schwarzfels; "..GREEN.."[2'] auf der Eingangskarte"..PREV..")";
L["Quest_7848_Note"] = "??";
...
L["Quest_9015_Note"] = "Dungeonset Questreihe.  Der Ring des Gesetzes ist bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_4083_Location"] = "Gloom'Rel (Schwarzfelstiefen; "..YELLOW.."[18]"..PREV..")";
L["Quest_4083_Note"] = "Dies ist eine Bergbauquest und erfordert einen Skill von mindestens 230 oder Höher um zu lernen wie man Dunkeleisenerz verhütten kann.  Du benötigst 2 Sternrubine, 20 Goldbarren und 10 Echtsilberbarren.  Wenn Du Dunkeleisenerz hast, kannst Du es zum Schwarzen Amboss bringen und dort verhütten bei "..YELLOW.."[22]"..PREV..".  Dies ist der einzigste Ort im Spiel um es verhütten zu können.";
...
L["Quest_4241_Location"] = "Marshal Maxwell (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_4241_Note"] = "Onyxia Einstimmungsqestreihe.  Diese startet bei Helendis Riverhorn (Brennende Steppe - Morgan's Vigil; "..YELLOW.."85.6, 68.8"..PREV..").\nMarshal Windsor ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_4242_Location"] = "Marshal Windsor (Schwarzfelstiefen; "..YELLOW.."[4]"..PREV..")";
L["Quest_4242_Note"] = "Onyxia Einstimmungsqestreihe.  Marshal Maxwell ist bei (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..").  Die nächste Quest in der Questreihe startet von einem zufälligen Dropp in den Schwarzfelstiefen.";
L["Quest_4242_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4264_Note"] = "Onyxia Einstimmungsqestreihe.  Marshal Windsor ist bei "..YELLOW.."[4]"..PREV..". Beste Chancen für diesen Dropp sind die Dunkeleisenzwerge.";
...
L["Quest_4282_Location"] = "Marshal Windsor (Schwarzfelstiefen; "..YELLOW.."[4]"..PREV..")";
L["Quest_4282_Note"] = "Onyxia Einstimmungsqestreihe.  Die verlorene Information droppt vom Golemlord Argelmach bei "..YELLOW.."[14]"..PREV.." und General Zornesschmied bei "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4322_Location"] = "Marshal Windsor (Schwarzfelstiefen; "..YELLOW.."[4]"..PREV..")";
L["Quest_4322_Note"] = "Onyxia Einstimmungsqestreihe.  Dies ist eine Begleitquest.  Sei Dir sicher das jeder aus der Gruppe diese Quest hat bevor ihr diese Startet.  Diese Quest ist leichter, wenn ihr den Ring des Gesetzes vorher säubert ("..YELLOW.."[6]"..PREV..") und den Gang zum Eingange. Du findest Marshal Maxwell in der Brennende Steppe- Morgan's Vigil ("..YELLOW.."84.6, 68.8"..PREV..").";
L["Quest_4322_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_4134_Location"] = "Schattenmagierin Vivian Lagrave (Ödland - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4134_Note"] = "Die Vorquest startet bei Apothekerin Zinge in Undercity - Das Apothekarium ("..YELLOW.."49.8 68.2"..PREV..").\nDu bekommst das Rezept von einen der Wachen, die erscheinen, wenn Du die Bierfässer zerstörst im Grimmigen Säufer bei "..YELLOW.."[15]"..PREV..".";
L["Quest_4134_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)"..AQ_AND.."3"..AQ_OR.."4";
...
L["Quest_4081_Location"] = "Steckbrief (Ödland - Kargath; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4081_Note"] = "Du kannst die Zwerge im ersten Teil der Dungeion finden. \nGebe die Quest ab beim Kriegsherr Goretooth bei (Ödland - Kargath, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4082_Location"] = "Steckbrief (Ödland - Kargath; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4082_Note"] = "Die Zwerge die Du brauchst sind in der Nähe von Bael'Gar bei "..YELLOW.."[11]"..PREV..". \nGebe die Quest ab beim Kriegsherr Goretooth bei (Ödland - Kargath, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4132_Location"] = "Kriegsherr (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4132_Note"] = "Um diese Quest machen zu können musst Du erst die beiden'SOFORT TÖTEN' Quests machen und dann starte die Quest Grark Lorkrub von Lexlort (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV.."). \nGeneral Angerforge ist bei "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4063_Location"] = "Lotwil Veriatus (Ödland; "..YELLOW.."26.0, 45.0"..PREV..")";
L["Quest_4063_Note"] = "Du bekommst die Vorquest von Hierophantin Theodora Mulvadania (Ödland - Kargath; "..YELLOW.."3.0, 47.8"..PREV..").\nGolem Lord Argelmach ist bei "..YELLOW.."[14]"..PREV..".";
L["Quest_4063_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_3906_Location"] = "Thunderheart (Ödland - Kargath; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3906_Note"] = "Übermeister Pyron ist ein Feuerelementar außerhalb der Dungeon.  Er patroulliert in der Nähe von "..YELLOW.."[24]"..PREV.." auf der Karte von den Schwarzfelstiefen bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_3907_Location"] = "Thunderheart (Ödland - Kargath; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3907_Note"] = "Du bekommst die Vorquest ebenfalls von Thunderheart.  Lord Incendius befindet sich beim Schwarzen Amboss bei "..YELLOW.."[10]"..PREV..".";
L["Quest_3907_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_7201_Location"] = "Schattenmagieren Vivian Lagrave (Ödland - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_7201_Note"] = "Du bekommst die Vorquest vom Thunderheart (Ödland - Kargath; "..YELLOW.."3.4, 48.2"..PREV..").\n Jedes Elementar kann die Essenz der Elemente droppen.";
...
L["Quest_3981_Location"] = "Galamav der Schütze (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
...
L["Quest_4003_Location"] = "Thrall (Orgrimmar - Tal der Weisheit; "..YELLOW.."32.0, 37.8"..PREV..")";
L["Quest_4003_Note"] = "Du findest Imperator Dagran Thaurissan bei "..YELLOW.."[21]"..PREV..".   Du musst Imperator Emperor Dagran Thaurissan besiegen und die Prinzessin muss überleben um diese Quest abzuschließen.  Wenn erfolgreich, kehre zum Kriegshäptling Thrall in Orgrimmar zurück und fordere Deine Belohnung ein.";
L["Quest_4003_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_8730_Location"] = "Vaelastrasz der Korrupte ist bei (Pechschwingenabstieg; "..YELLOW.."[2]"..PREV..")";
L["Quest_8730_Note"] = "Nur eine Person kann den Splitter aufnehmen.  Anachronos ist bei (Tanaris - Höhlen der Zeit; "..YELLOW.."65, 49"..PREV..")";
L["Quest_8730_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7781_Location"] = "Kopf von Nefarian (droppt von Nefarian; "..YELLOW.."[8]"..PREV..")";
L["Quest_7781_Note"] = "Hochlord Bolvar Fordragon ist bei (Stormwind - Burg Stormwind; "..YELLOW.."78.0, 18.0"..PREV.."). Die Folgequest führt Dich zu Feldmarschall Afrasiabi (Stormwind - Tal der Helden; "..YELLOW.."66.9, 72.38"..PREV..") um die Belohnung zu erhalten.";
L["Quest_7781_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8288_Location"] = "Kopf vom Brutwächter Dreschbringer (droppt von Brutwächter Dreschbringer; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_7783_Location"] = "Kopf von Nefarian (droppt von Nefarian; "..YELLOW.."[8]"..PREV..")";
L["Quest_7783_Note"] = "Die Folgequest führt Dich zum Oberanführer Runthak (Orgrimmar - Tal der Stärke; "..YELLOW.."51.6, 76.0"..PREV..") um die Belohnung zu erhalten.";
L["Quest_7783_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4788_Location"] = "Ausgrabungsleiter Ironboot (Tanaris - Steamwheedle Port; "..YELLOW.."66.8, 24.0"..PREV..")";
L["Quest_4788_Note"] = "Du findest die Tafeln in der Nähe von Schattenjäger Vosh'gajin bei "..YELLOW.."[7]"..PREV.." und Kriegsmeister Voone bei "..YELLOW.."[8]"..PREV..".\nDie Belohnung erhälst Du von der Folgequest.  Die Questreihe startet bei Yeh'kinya in Tanaris ("..YELLOW.."67.0, 22.4"..PREV..").";
L["Quest_4788_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_4729_Location"] = "Kibler (Brennende Steppe - Flammenkamm; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4729_Note"] = "Du findest die Worhwelpen in der Nähe von Halcyon bei "..YELLOW.."[16]"..PREV..".";
...
L["Quest_4862_Location"] = "Kibler (Brennende Steppe - Flammenkamm; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4862_Note"] = "Du findest die Spitzenspinnen-Eier in der Nähe von Mutter Glimmernetz bei "..YELLOW.."[11]"..PREV..".";
...
L["Quest_4866_Location"] = "Ragged John (Brennende Steppe - Flammenkamm; "..YELLOW.."65.0, 23.6"..PREV..")";
L["Quest_4866_Note"] = "Mutter Glimmernetz ist bei "..YELLOW.."[11]"..PREV..". Der Gifteffekt kann jeden Spieler erwischen. Wenn der Effekt entfernt wird, scheiterst Du auch an der Quest.";
...
L["Quest_4701_Location"] = "Helendis Riverhorn (Brennende Steppe - Morgan's Vigil; "..YELLOW.."85.6, 68.8"..PREV..")";
L["Quest_4701_Note"] = "Du findest Halycon bei "..YELLOW.."[16]"..PREV..".";
L["Quest_4701_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_4867_Name"] = "Urok Schreckensbote";
L["Quest_4867_Objective"] = "Lest Waroshs Rolle. Bringt Waroshs Mojo zu Warosh.";
L["Quest_4867_Location"] = "Warosh (Schwarzfelsspitze; "..YELLOW.."[2]"..PREV..")";
L["Quest_4867_Note"] = "Um Waroshs Mojo zu bekommen, musst Du Urok Doomhowl beschwören und töten "..YELLOW.."[13]"..PREV..". Für die Beschwörung brauchst Du einen Speer und den Kopf von Hochlord Omokk "..YELLOW.."[6]"..PREV..". Der Speer ist bei "..YELLOW.."[4]"..PREV..". Während der Beschwörung erscheinen einige Wellen von Ogern bevor Urok Doomhowl erscheint.";
...
L["Quest_5001_Location"] = "Bijou (Schwarzfelsspitze; "..YELLOW.."[3]"..PREV..")";
L["Quest_5001_Note"] = "Du findest Bijous Habseligkeiten auf den Weg zu Mutter Glimmernetz bei "..YELLOW.."[11]"..PREV..".\nTDie Folgeqquest führt Dich zu Marshal Maxwell bei (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..").";
...
L["Quest_5081_Location"] = "Marshal Maxwell (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5081_Note"] = "Du findest Kriegsmeister Voone bei "..YELLOW.."[8]"..PREV..", Hochlord Omokk bei "..YELLOW.."[6]"..PREV.." und Oberanführer Wyrmthalak bei "..YELLOW.."[17]"..PREV..".";
L["Quest_5081_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_4742_Location"] = "Vaelan (Schwarzfelsspitze; "..YELLOW.."[1]"..PREV..")";
L["Quest_4742_Note"] = "Dies ist die Quest für den Schlüssel für die Obere Schwarzfelsspitze.  Du bekommst den Edelstein der Felsspitzoger von Hochlord Omokk bei "..YELLOW.."[6]"..PREV..", den Edelstein der Gluthauer von Kriegsmeister Voone bei "..YELLOW.."[8]"..PREV.." und den Edelstein der Blutäxte von Obermeister Wyrmthalak bei "..YELLOW.."[17]"..PREV..".  Das Unverziertes Siegel des Aufstiegs kann von jedem Gegner innerhalb und außerhalb der Instanz droppen.";
...
L["Quest_5089_Location"] = "General Drakkisaths Befehl (droppt vom Hochlorrd Wyrmthalak; "..YELLOW.."[17]"..PREV..")";
L["Quest_5089_Note"] = "Marshal Maxwell ist in der Brennende Steppe - Morgan's Vigil; ("..YELLOW.."84.6, 68.8"..PREV..").";
L["Quest_5089_FollowQuest"] = "General Drakkisaths Befehl ("..YELLOW.."Untere Schwarzfelsspitze"..PREV..")";
...
L["Quest_8989_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
...
L["Quest_8989_FollowQuest"] = "Letzte Vorbereitungen ("..YELLOW.."Untere Schwarzfelsspitze"..PREV..")";
...
L["Quest_5306_Location"] = "Kilram (Winterspring - Everlook; "..YELLOW.."61.2, 37.0"..PREV..")";
L["Quest_5306_Note"] = "Schmiedekunstquest.  Schattenjäger Vosh'gajin ist bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_5103_Location"] = "Human Remains (Untere Schwarzfelsspitze; "..YELLOW.."[9]"..PREV..")";
L["Quest_5103_Note"] = "Schmiedekunstquest.  Stelle sicher, dass Du die Feurige Plattenstulpen von den menschlichen Überreste aufhebst, in der Nähe von "..YELLOW.."[9]"..PREV..". Kehre zurück zu Malyfous Darkhammer (Winterspring - Everlook; "..YELLOW.."61.0, 38.6"..PREV..").  Die Belohungen sind für die Folgequest.";
L["Quest_5103_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_4724_Location"] = "Galamav der Schütze (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4724_Note"] = "Du findest Halycon bei "..YELLOW.."[15]"..PREV..".";
L["Quest_4724_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4981_Location"] = "Lexlort (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4981_Note"] = "Du findest Bijou bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_4982_Location"] = "Bijou (Schwarzfelsspitze; "..YELLOW.."[3]"..PREV..")";
L["Quest_4982_Note"] = "Du findest die Habseligkeiten auf den Weg zu Mutter Glimmernetz bei "..YELLOW.."[11]"..PREV..".\nDie Belohnung bekommst Du aus der Folgequest, welche Dich zu Lexlort zurückführt, in (Ödland - Kargath; "..YELLOW.."5.8, 47.6"..PREV..").";
L["Quest_4982_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_4903_Location"] = "Kriegsherr Goretooth (Ödland - Kargath; "..YELLOW.."65,22"..PREV..")";
L["Quest_4903_Note"] = "Onyxia Einstimmungsqestreihe.  Du findest Hochlord Omokk bei "..YELLOW.."[6]"..PREV..", Kriegsmeister Voone bei "..YELLOW.."[8]"..PREV.." und Oberanführer Wyrmthalak bei "..YELLOW.."[17]"..PREV..".  Die Blackrockdokumente erscheienn bei einen der 3 Bosse.";
L["Quest_4903_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_4903_FollowQuest"] = "Eitriggs Weisheit -> Für die Horde! ("..YELLOW.."Untere Schwarzfelsspitze"..PREV..")";
...
L["Quest_5160_Location"] = "Awbee (Schwarzfelsspitze; "..YELLOW.."[6]"..PREV..")";
L["Quest_5160_Note"] = "Du findest Awbee in den Raum hinter der Arena bei "..YELLOW.."[6]"..PREV..". Sie steht auf einem Vorsprung.\nHaleh ist in Winterspring ("..YELLOW.."54.4, 51.2"..PREV..").  Es gibt eine Höhle bei den Koordinaten "..YELLOW.."57.0, 50.0"..PREV..".  Am Ende ist ein Portal, dass Dich zu Haleh portet.";
...
L["Quest_5047_Location"] = "Pip Quickwit (Schwarzfelsspitze; "..YELLOW.."[7]"..PREV..")";
L["Quest_5047_Note"] = "Pip Quickwit erscheint nach der Tötung der Bestie. Du findest Malyfous Darkhammer in (Winterspring - Everlook; "..YELLOW.."61.0, 38.6"..PREV..").";
...
L["Quest_4734_Location"] = "Tinkee Steamboil (Brennende Steppe - Flammenkamm; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4734_Note"] = "Du findest die Eier in dem Raum Vatersflammen bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6821_Location"] = "Fürst Hydraxis (Azshara; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6821_Note"] = "Du findest Glutseher Emberseer bei "..YELLOW.."[1]"..PREV..".  Diese Quest gibt Dir den Ewige Quintessenz, welches Du für den Raid 'Geschmolzener Kern' benötigst.";
...
L["Quest_5102_Location"] = "Marshal Maxwell (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5102_Note"] = "Du findest General Drakkisath bei "..YELLOW.."[8]"..PREV..".";
L["Quest_5102_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_5102_PreQuest"] = "General Drakkisaths Befehl ("..YELLOW.."Untere Schwarzfelsspitze"..PREV..")";
...
L["Quest_4764_Location"] = "Mayara Brightwing (Brennende Steppe - Morgan's Vigil; "..YELLOW.."84.8, 69.0"..PREV..")";
L["Quest_4764_Note"] = "Du bekommst die Vorquest von Graf Remington Ridgewell (Stormwind - Burg Stormwind; "..YELLOW.."74.0, 30.0"..PREV..").\n\nDoomriggers Schnalle ist bei "..YELLOW.."[2]"..PREV.." in einer Truhe.  Die Belohnung erhälst Du in der Folgequest.";
L["Quest_4764_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7761_Location"] = "Blackhands Befehl (droppt vom Rüstmeister der Schmetterschilde; "..YELLOW.."[1] auf der Eingangskarte"..PREV..")";
L["Quest_7761_Note"] = "Pechschwingenabstieg Einstimmungsquest. Rüstmeister der Schmetterschilde kannst Du finden, wenn Du vor dem LBRS/UBRS Portal, rechts abbiegst.\n\nGeneral Drakkisath ist bei "..YELLOW.."[8]"..PREV..". Das Brandzeichen ist hinter ihm.";
...
L["Quest_8994_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
...
L["Quest_8995_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
L["Quest_8995_Note"] = "Dungeonrüstungsset Questreihe  Der Extradimensionaler Geisterdetektor wird benötigt um Bodley zu sehen. Du bekommst dies aus der Quest 'Suche nach Anthion'.  Lord Valthalak ist beschwörbar bei "..YELLOW.."[7]"..PREV..".  Die Belohnung erhälst Du in der Folgequest.";
L["Quest_8995_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_5127_Location"] = "Lorax (Winterspring; "..YELLOW.."64, 74"..PREV..")";
L["Quest_5127_Note"] = "Schmiedekunstquest.  Goraluk Hammerbruch ist bei "..YELLOW.."[4]"..PREV..".";
L["Quest_5127_RewardText"] = WHITE.."1"..AQ_AND.."2 "..AQ_AND.."3 (x5)";
...
L["Quest_4735_Location"] = "Tinkee Steamboil (Brennende Steppe - Flammenkamm; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4735_Note"] = "Du findest die Eier im Raum von Vatersflammen bei "..YELLOW.."[2]"..PREV..".";
L["Quest_4735_PreQuest"] = "Ei-Frosten";
L["Quest_4735_FollowQuest"] = "Leonid Barthalomew -> Dämmerungstrickfalle  ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_6502_Location"] = "Haleh (Winterspring; "..YELLOW.."54.4, 51.2"..PREV..")";
L["Quest_6502_Note"] = "Dies ist die letze Quest für die Onyxiaeinstimmungsquestreihe.  Weitere Information, um diese Questreihe zu starten, siehe bei der Quest 'Marshal Windsor'.  Du findest General Drakkisath bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_4768_Location"] = "Vivian Lagrave (Ödland - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4768_Note"] = "Du bekommst die Vorquest von Apothekerin Zinge in Undercity - Das Apothekarium ("..YELLOW.."50.0, 68.6"..PREV..").\n\nDie Darkstone-Schrifttafel ist bei "..YELLOW.."[3]"..PREV.." in einer Truhet.";
L["Quest_4768_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_4974_Location"] = "Thrall (Orgrimmar; "..YELLOW.."32, 37.8"..PREV..")";
L["Quest_4974_Note"] = "Onyxia Einstimmungsqestreihe.  Du findest Kriegshäuptling Rend Blackhand bei "..YELLOW.."[5]"..PREV..".";
L["Quest_4974_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_6569_Location"] = "Myranda die Vettel (Westliche Pestländer - Sorrow Hill; "..YELLOW.."50.8, 77.8"..PREV..")";
...
L["Quest_6602_Note"] = "Letzte Quest der Onyxia Einstimmungsqestreihe.  Rexxar erscheint an der Grenze vom Steinkrallengebirge und wandert rüber nach Desolace Richtung Feralas.  Der beste Weg ihn zu finden, starte in Feralas bei "..YELLOW.."48.2, 24.8"..PREV.." und wandere in Richtung Norden um ihm abzufangen.   Du findest General Drakkisath bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_214_Location"] = "Späherin Riell (Westfall - Späherkuppe; "..YELLOW.."56.6, 47.4"..PREV..")";
...
L["Quest_214_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_168_Location"] = "Wilder Thistlenettle (Stormwind - Zwergendistrikt; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_168_Note"] = "Die Gewerkschaftsausweiße droppen außerhalb der Instanz von den Untoten in der Nähe von "..YELLOW.."[3]"..PREV.." auf der Eingangskarte.";
L["Quest_168_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_167_Location"] = "Wilder Thistlenettle (Stormwind - Zwergendistrikt; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_167_Note"] = "Großknecht Thistlenettle findest Du außerhalb der Instnaz in der Nähe von "..YELLOW.."[3]"..PREV.." auf der Eingangskarte.";
...
L["Quest_2040_Location"] = "Shoni der Schtillen (Stormwind - Zwergendistrikt; "..YELLOW.."62.6, 34.1"..PREV..")";
L["Quest_2040_Note"] = "Die optionale Vorquest bekommst Du von Gnoarn (Ironforge - Tüftlerstadt; "..YELLOW.."69.4, 50.6"..PREV..").\nSneed's Schredder droppt vom Gnoam Sprecklesprocket bei "..YELLOW.."[3]"..PREV..".";
L["Quest_2040_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_166_Location"] = "Gryan Stoutmantle (Westfall - Späherkuppe; "..YELLOW.."56.2, 47.6"..PREV..")";
L["Quest_166_Note"] = "Du Startet die Questreihe bei Gryan Stoutmantle.\nEdwin VanCleef ist der letzte Boss. Du findest ist ganz oben auf dem Schiff bei "..YELLOW.."[6]"..PREV..".";
L["Quest_166_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1654_Location"] = "Jordan Stilwell (Dun Morogh - Ironforge Eingang; "..YELLOW.."52,36"..PREV..")";
L["Quest_1654_Note"] = "Paladinquest.  Du bekommst das Weißsteineichenholz von Goblin Holzschnitzer bei "..YELLOW.."[3]"..PREV..".\n\nDie anderen Teile bekommst Du von Burg Shadowfang, Loch Modan, Dunkelküste und Ashenvale.  Einige erfordern Nebenaufgaben.  Empfehlung, schaut auf Wowhead nach.";
...
L["Quest_373_Location"] = "Ein nie abgeschickter Brief (droppt von Edwin VanCleef; "..YELLOW.."[6]"..PREV..")";
L["Quest_373_Note"] = "Baros Alexston ist in Stormwind, in der Kathredale des Lichts bei "..YELLOW.."49.0, 30.2"..PREV..".";
...
L["Quest_2922_Location"] = "Tüftlermeister Overspark (Ironforge - Tüftlerstadt; "..YELLOW.."69,50"..PREV..")";
L["Quest_2922_Note"] = "Du Vorquest bekommst Du von Bruder Sarno (Stormwind - Kathedralenplatz; "..YELLOW.."50.9, 47.8"..PREV..").\nDu findest Techbot bevor Du die Instanz betretest in der Nähe der Hintertür bei "..YELLOW.."[4] auf der Eingangskarte"..PREV..".";
...
L["Quest_2926_Location"] = "Ozzie Togglevolt (Dun Morogh - Kharanos; "..YELLOW.."45,49"..PREV..")";
L["Quest_2926_Note"] = "Du Vorquest bekommst Du von Gnoarn (Ironforge - Tüftlerstadt; "..YELLOW.."69,50"..PREV..").\nUm die Ablagerungen zu bekommst, musst Du die Phiole auf die "..RED.."Lebenden"..PREV.." betrahlten Plünderer oder Eindringlinge anwenden.";
...
L["Quest_2962_Location"] = "Ozzie Togglevolt (Dun Morogh - Kharanos; "..YELLOW.."45,49"..PREV..")";
L["Quest_2962_Note"] = "Um die Ablagerungen zu bekommst, musst Du die Phiole auf die "..RED.."Lebenden"..PREV.." betrahlten Brühschleimern, Lauerern und Schrecken anwenden.";
...
L["Quest_2928_Location"] = "Shoni die Schtille (Stormwind - Zwergendistrikt; "..YELLOW.."62.6, 34.1"..PREV..")";
L["Quest_2928_Note"] = "Alle Roboter können die Innereien droppen.";
L["Quest_2928_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_2924_Location"] = "Klockmort Spannerspan (Ironforge - Tüftlerstadt; "..YELLOW.."68,46"..PREV..")";
L["Quest_2924_Note"] = "Du bekommst die Vorquest von Mathiel (Darnassus - Terasse der Krieger; "..YELLOW.."59,45"..PREV..").\nDie grundlegende Artifixe kommen von den Geräten, die überall in der Instanz verteilt sind.";
...
L["Quest_2930_Location"] = "Mechanikermeister Castpipe (Ironforge - Tüftlerstadt; "..YELLOW.."69,48"..PREV..")";
L["Quest_2930_Note"] = "Die Vorquest erhälst du von Gaxim Rustfizzle (Steinkrallengebirge; "..YELLOW.."59,67"..PREV..").\nDie Karte kann von jedem Gegner droppen. Du findeest das 1. Terminal neben dem Hintereingang, bevor Sie die Instanz betrits, bei  "..YELLOW.."[3] auf der Eingangskarte"..PREV..". Der 3005-B ist bei "..YELLOW.."[3]"..PREV..", der 3005-C at "..YELLOW.."[5]"..PREV.." und der 3005-D ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_2930_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_2904_Location"] = "Kernobee (Gnomeregan; "..YELLOW.."[3]"..PREV..")";
L["Quest_2904_Note"] = "Begleitquest! Du findest Scooty in Schlingendorntal - Booty Bay ("..YELLOW.."27,77"..PREV..").";
L["Quest_2904_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_2929_Location"] = "Hochtüftler Mekkatorque (Ironforge - Tüftlerstadt; "..YELLOW.."68,48"..PREV..")";
L["Quest_2929_Note"] = "Du findest Thermaplugg bei "..YELLOW.."[8]"..PREV..".\nWähredn des Kampfes, musst Du die Hebel an den Säulen deaktiviren.";
L["Quest_2929_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_2945_Note"] = "Der Ring kann gereinigt werden mit dem Funkelmat 5200 in 'Die sauberen Zone' bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2947_Note"] = "Kehre zurück zusTalvash del Kissel (Ironforge - Mystikerviertel; "..YELLOW.."36,3"..PREV.."). Die Folgequest des Ringes ist optional.";
...
L["Quest_2951_Location"] = "Funkelmat 5200 (Gnomeregan - Die saubere Zone; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_2843_Location"] = "Scooty (Schlingendorntal - Booty Bay; "..YELLOW.."27,77"..PREV..")";
L["Quest_2843_Note"] = "Du bekommst die Vorquest von Sovik (Orgrimmar - Tal der Ehre; "..YELLOW.."75,25"..PREV..").\nWenn Du die Quest beendet hast, kannst Du den Transporter in Booty Bay benutzen.";
...
L["Quest_2841_Location"] = "Nogg (Orgrimmar - Tal der Ehre; "..YELLOW.."75,25"..PREV..")";
L["Quest_2841_Note"] = "Du findest Thermaplugg bei "..YELLOW.."[8]"..PREV..".\nWähredn des Kampfes, musst Du die Hebel an den Säulen deaktiviren.";
L["Quest_2841_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_2949_Note"] = "Kehre zurück zu Nogg (Orgrimmar - Tal der Ehre; "..YELLOW.."75,25"..PREV.."). Die Folgequest des Ringes ist optional.";
...
L["Quest_1050_Location"] = "Bilbliothekarin Mae Paledust (Ironforge - Halle der Forscher; "..YELLOW.."74,12"..PREV..")";
L["Quest_1050_Note"] = "Das Buch befindet sich auf dem Boden auf der linken Seite im letzten Korridor, die zum Arkanist Doan führt ("..YELLOW.."[2]"..PREV..").";
...
L["Quest_1951_Location"] = "Tabetha (Dustwallow Marsehen; "..YELLOW.."43,57"..PREV..")";
L["Quest_1951_Note"] = "Diese Quest ist nur für Magier. Du findet das Buch im letzten Korridor auf dem Weg zum Atkanist Doan ("..YELLOW.."[2]"..PREV..").\n\nDie Belohnung erhälst Du in der Folgequest.";
L["Quest_1951_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1053_Location"] = "Raleigh der Andächtige ( Vorgebirge von Hillsbrad - Südshore; "..YELLOW.."51,58"..PREV..")";
L["Quest_1053_Note"] = "Die Questreihe startet bei Bruder Crowley in Stormwind - Kathedrale des Lichts ("..YELLOW.."52.3, 43.1"..PREV..").\nDu findest Hochinquisitorr Whitemane und Scharlachroter Kommandant Mograine bei "..YELLOW.."SM: Kathedrale [2]"..PREV..", Herod bei "..YELLOW.."SM: Waffenkammer [1]"..PREV.." und Hundemeister Loksey bei "..YELLOW.."SM: Bibliothek [1]"..PREV..".";
...
L["Quest_1113_Location"] = "Apothekenmeister Faranell (Undercity - Das Apothekarium; "..YELLOW.."48,69"..PREV..")";
...
L["Quest_1113_PreQuest"] = "Going, Going, Guano! ("..YELLOW.."[Kral der Razforzen]"..PREV..")";
...
L["Quest_1160_Location"] = "Parqual Fintallas (Undercity - Das Apothekarium; "..YELLOW.."57,65"..PREV..")";
L["Quest_1160_Note"] = "Questreihe startet bei Dorn Plainstalker (Thausend Nadeln; "..YELLOW.."53,41"..PREV.."). Du findest das Buch in den Scharlachroten Hallen.\n\nDie Belohnung erhälst Du in den Folgequesten, die nur beinhalten mit den NPC zu sprechen.";
L["Quest_1160_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_1048_Location"] = "Varimathras (Undercity - Königliches Quartier; "..YELLOW.."56,92"..PREV..")";
L["Quest_1048_Note"] = "Du findest Hochinquisitor Whitemane und Scharlachroten Kommandant Mograine bei "..YELLOW.."SM: Kathedrale [2]"..PREV..", Herod bei "..YELLOW.."SM: Armory [1]"..PREV.." and Hundemeister Loksey bei "..YELLOW.."SM: Bibliothek [1]"..PREV..".";
L["Quest_1048_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1051_Location"] = "Vorrel Sengutz (Scharlachroter Kloster - Friedhof; "..YELLOW.."[1]"..PREV..")";
L["Quest_1051_Note"] = "Du findest Vorrel Sengutz am Anfang der Instanz der Scharlachroten Kloster Friedhof. Nancy Vishas, die den Ring für diese Quest fallen lässt, kann in einem Haus im Alteracgebirge ("..YELLOW.."31,32"..PREV..").";
L["Quest_1051_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_5529_Location"] = "Betina Bigglezink (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.6, 53.6"..PREV..")";
...
L["Quest_5582_Note"] = "Geplagte Jungtiere droppen die gesunde Großdrachenschuppen (8% Chance zu droppen). Du findest Betina Bigglezink in Östliche Pestländer - Kapelle des hoffnungsvollen Lichts ("..YELLOW.."75.6, 53.6"..PREV..").";
...
L["Quest_5382_Location"] = "Eva Sarkhoff (Westliche Pestländer - Caer Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5382_Note"] = "Du findest Doktor Theolen Krastinov, die Überreste von Eva Sarkhoff und die Überreste von Lucien Sarkhoff bei "..YELLOW.."[9]"..PREV..".";
...
L["Quest_5515_Location"] = "Eva Sarkhoff (Westliche Pestländer - Caer Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5515_Note"] = "Du findest Jandice Barov bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_5384_Location"] = "Eva Sarkhoff (Westliche Pestländer - Caer Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5384_Note"] = "Die Veranda ist bei "..YELLOW.."[2]"..PREV..".";
L["Quest_5384_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_5466_Location"] = "Magistrate Marduke (Westliche Pestländer - Caer Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5466_Note"] = "Du findest Ras Frostwhisper bei "..YELLOW.."[7]"..PREV..".";
L["Quest_5466_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5343_Location"] = "Weldon Barov (Westliche Pestländer - Chillwind Lager; "..YELLOW.."43,83"..PREV..")";
L["Quest_5343_Note"] = "Du findest die Besitzurkunde für Caer Darrow bei "..YELLOW.."[12]"..PREV..", Besitzurkunde für Brill bei "..YELLOW.."[7]"..PREV..", Besitzurkunde für Tarrens Mühle bei "..YELLOW.."[4]"..PREV.." und Besitzurkunde für Südshore bei "..YELLOW.."[1]"..PREV..".\nDie Belohnung erhälst Du in der Folgeuest.";
...
L["Quest_4771_Location"] = "Betina Bigglezink (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.6, 53.6"..PREV..")";
L["Quest_4771_Note"] = "Brutlingessenz beginnt bei Tinkee Steamboil (Brennende Steppe - Flammenkamm; "..YELLOW.."65,23"..PREV.."). Der Vorführraum ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_4771_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7629_Location"] = "Gorzeeki Wildeyes (Brennende Steppe; "..YELLOW.."12,31"..PREV..")";
L["Quest_7629_Note"] = "Nur Hexenmeister bekommen diese Quest! Du findest das Alchimielabor bei "..YELLOW.."[7]"..PREV..".";
L["Quest_7629_PreQuest"] = "Mor'zul Bloodbringer - > Xorothianischer Sternenstaub";
L["Quest_7629_FollowQuest"] = "Schreckensross von Xoroth ("..YELLOW.."Düsterbruch West"..PREV..")";
...
L["Quest_8992_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
...
L["Quest_8992_FollowQuest"] = "Letzte Vorbereitungen ("..YELLOW.."Obere Schwarzfelsspitze"..PREV..")";
...
L["Quest_7647_Location"] = "Lord Grayson Shadowbreaker (Stormwind City - Kathedrale; "..YELLOW.."37.6, 32.6"..PREV..")";
L["Quest_7647_Note"] = "Paladin Episches Reittierquestreihe  Diese Questreihe ist lang und hat viele Schritte. Das Große Ossuariumbefindet sich bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_5341_Location"] = "Alexi Barov (Tirisfal- Das Bollwerk; "..YELLOW.."80,73"..PREV..")";
L["Quest_5341_Note"] = "Du findest die Besitzurkunde für Caer Darrow bei "..YELLOW.."[12]"..PREV..", Besitzurkunde für Brill bei "..YELLOW.."[7]"..PREV..", Besitzurkunde für Tarrens Mühle bei "..YELLOW.."[4]"..PREV.." und Besitzurkunde für Südshore bei "..YELLOW.."[1]"..PREV..".\nDie Belohnung erhälst Du in der Folgeuest.";
...
L["Quest_8258_Location"] = "Sagorne Creststrider (Orgrimmar - Tal der Weisheit; "..YELLOW.."38.6, 36.2"..PREV..")";
L["Quest_8258_Note"] = "Dies Quest ist nur für Schamanen. Die Vorquest bekommst Du vom den selben NPC.\n\nTodesitter Schattensichel erscheint bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_1740_Location"] = "Doan Karhan (Brachland; "..YELLOW.."49,57"..PREV..")";
L["Quest_1740_Note"] = "Nur Hexenmeister bekommen diese Quest! Du bekommst die 3 Soran'ruk-Fragmente von den Twilight Akolyten in "..YELLOW.."[Blackfathom-Tiefe]"..PREV..". Du bekommst das großes Soran'ruk-Fragment in "..YELLOW.."[Burg Shadowfang]"..PREV.." von Shadowfang-Dunkelseele.";
L["Quest_1740_RewardText"] = WHITE.."1"..AQ_OR.."2";

L["Quest_1098_Name"] = "Todespirscher in Shadowfang";
L["Quest_1098_Objective"] = "Sucht die Todespirscher Adamant und Vincent.";
L["Quest_1098_Location"] = "Hochexekutor Hadrec (Silberwald - Das Grabmal; "..YELLOW.."43,40"..PREV..")";
L["Quest_1098_Note"] = "Du findest Todespirscher Adamant bei "..YELLOW.."[1]"..PREV..". Todespirscher Vincent ist auf der rechten Seite wenn Du den Hof betritts bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_1013_Location"] = "Bawahrer Bel'dugur (Undercity - Das Apothekarium; "..YELLOW.."53,54"..PREV..")";
L["Quest_1013_Note"] = "Du findest das Buch bei "..YELLOW.."[11]"..PREV.." auf der linken Seite wenn Du den Raum betritts.";
L["Quest_1013_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_1014_Location"] = "Dalar Dawnweaver (Silberwald - Das Grabmal; "..YELLOW.."44,39"..PREV..")";
L["Quest_1014_Note"] = "Du findest Erzmagier Arugal bei "..YELLOW.."[13]"..PREV..".";
...
L["Quest_386_Location"] = "Wache Berton (Steinkrallengebirge - Seenhain; "..YELLOW.."26,46"..PREV..")";
L["Quest_386_Note"] = "Du findest Targorr bei "..YELLOW.."[1]"..PREV..".";
L["Quest_386_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_377_Location"] = "Ratsherr Millstipe (Dämmerwald - Dunkelhain; "..YELLOW.."72,47"..PREV..")";
L["Quest_377_Note"] = "Du findest Dextren bei "..YELLOW.."[5]"..PREV..".";
L["Quest_377_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_387_Location"] = "Warden Thelwater (Stormwind - Das Verlies; "..YELLOW.."51.4, 68.8"..PREV..")";
...
L["Quest_388_Location"] = "Nikova Raskol (Stormwind - Altstadt; "..YELLOW.."75.6, 62.9"..PREV..")";
...
L["Quest_378_Location"] = "Motley Garmason (Sumpfland - Dun Modr; "..YELLOW.."49,18"..PREV..")";
L["Quest_378_Note"] = "Die Vorquest bekommst Du ebenfalls von Motley Garmason die abgeschlossen werden muss. Du findest Kam Deepfury bei "..YELLOW.."[2]"..PREV..".";
L["Quest_378_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_391_Location"] = "Warden Thelwater (Stormwind - Das Verlies; "..YELLOW.."51.4, 68.8"..PREV..")";
L["Quest_391_Note"] = "Weitere Informationen zur vorherigen Quest findest du unter "..YELLOW.."[Todesmine, Die Defias Bruderschaft]"..PREV..".\nDu findest Bazil Thredd bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_5212_Location"] = "Betina Bigglezink (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.6, 53.6"..PREV..")";
...
L["Quest_5213_Location"] = "Betina Bigglezink (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.6, 53.6"..PREV..")";
L["Quest_5213_Note"] = "Der aktive Wirkstoff findest Du in einen der drei Türmen in der Nähe von "..YELLOW.."[15]"..PREV..", "..YELLOW.."[16]"..PREV.." und "..YELLOW.."[17]"..PREV..".";
L["Quest_5213_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_5243_Location"] = "Leonid Barthalomew der Geachtete (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.8, 52.0"..PREV..")";
...
L["Quest_5243_RewardText"] = WHITE.."1 (x5)"..AQ_AND.."2 (x5)"..AQ_AND.."3"..AQ_OR.."4";
...
L["Quest_5214_Location"] = "Smokey LaRue (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."74.8, 52.0"..PREV..")";
L["Quest_5214_Note"] = "Du findest den Raucherladen in der Nähe von "..YELLOW.."[1]"..PREV..". Fras Siabi erscheint wenn Du die Box öffnest.";
...
L["Quest_5282_Location"] = "Egan (Östliche Pestländer; "..YELLOW.."11.3, 28.7"..PREV..")";
L["Quest_5282_Note"] = "Du bekommst die Vorquest von Caretaker Alen (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."74,58"..PREV.."). The Spectral Citizens walk through the streets of Stratholme.";
...
L["Quest_5848_Location"] = "Grafiker Renfray (Westliche Pestländer - Caer Darrow; "..YELLOW.."65,75"..PREV..")";
L["Quest_5848_Note"] = "Du bekommst die Vorquest von Tirion Fordring (Westliche Pestländer; "..YELLOW.."7,43"..PREV.."). Du findest das Gemälde in der Nähe von "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5463_Location"] = "Leonid Barthalomew der Geachtete (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."75.8, 52.0"..PREV..")";
L["Quest_5463_Note"] = "Du bekommst die Vorquest von Magistrate Marduke (Westliche Pestländer - Caer Darrow; "..YELLOW.."70,73"..PREV.."). Du findest das Zeichen in der Nähe von "..YELLOW.."[19]"..PREV..". Siehe auch "..YELLOW.."[Der Lich Ras Frostraunen]"..PREV.." in Scholomance.";
...
L["Quest_5125_Location"] = "Aurius (Stratholme; "..YELLOW.."[13]"..PREV..")";
L["Quest_5125_Note"] = "Du bekommst das Medaillon aus einer Kiste (Malors Geldkasstte "..YELLOW.."[7]"..PREV..") in der ersten Kammer der Bastion.\n\nNachdem Du Aurius das Medaillon gegeben hast, wird er Dir beim Bosskampf gegen Baron Rivendare helfen"..YELLOW.."[19]"..PREV..". Nach dem Tod des Barons wird auch Aurius sterben. Sprich mit seiner Leiche, um die Belohnung zu erhalten.";
L["Quest_5125_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_5251_Location"] = "Fürst Nicholas Zverenhoff (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."76,52"..PREV..")";
L["Quest_5251_Note"] = "Du findest das abgebrannte Archiv und den Archivar bei "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5262_Location"] = "Balnazzar (Stratholme; "..YELLOW.."[11]"..PREV..")";
L["Quest_5262_Note"] = "Du findesz Fürst Nicholas Zverenhoff in den östlichen Pestländer - Kapelle des hoffnungsvollen Lichts ("..YELLOW.."76,52"..PREV..").";
...
L["Quest_5263_Location"] = "Fürst Nicholas Zverenhoff (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."76,52"..PREV..")";
L["Quest_5263_Note"] = "Du findest den Baron bei "..YELLOW.."[19]"..PREV..".\n\nDie Belohnung erhälst Du mit der Folgequest.";
L["Quest_5263_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8945_Note"] = "Anthion stands just outside the Stratholme portal. You need the Extra-Dimensional Ghost Revealer to see him. It comes from the pre-quest. The questline starts with Just Compensation. Deliana in Ironforge ("..YELLOW.."43,52"..PREV..") for Alliance, Mokvar in Orgrimmar ("..YELLOW.."38,37"..PREV..") for Horde.\nThis is the infamous '45 minute' Baron run.";
...
L["Quest_8991_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
...
L["Quest_8991_FollowQuest"] = "Letzte Vorbereitungen ("..YELLOW.."Obere Schwarzfelsspitze"..PREV..")";
...
L["Quest_9257_Location"] = "Anachronos (Tanaris - Höhlen der Zeit; "..YELLOW.."65,49"..PREV..")";
L["Quest_9257_Note"] = "Atiesh erscheint bei "..YELLOW.."[2]"..PREV..".";
L["Quest_9257_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5307_Location"] = "Seril Scourgebane (Winterspring - Everlook; "..YELLOW.."61,37"..PREV..")";
L["Quest_5307_Note"] = "Der Schwertschmied ist in der Nähe von "..YELLOW.."[15]"..PREV..".";
...
L["Quest_5305_Location"] = "Lilith die Liebliche (Winterspring - Everlook; "..YELLOW.."61,37"..PREV..")";
L["Quest_5305_Note"] = "Der purpurroten Hammerschmied erscheint bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_7622_Location"] = "Eris Havenfire (Östliche Pestländer; "..YELLOW.."17.6, 14.0"..PREV..")";
L["Quest_7622_Note"] = "Um Eris Havenfire zu sehen und seine Quest, sowie Vorquest zu erhalten, brauchst Du Das Auge der Offenbarung (bekommst Du von Majordomus Executus aus "..YELLOW.."[Molten Core]"..PREV..").\n\nDie Questbelohnung erhälst Du, wenn du die Gegnstände 'Das Auge der Offenbarung' und 'Das Auge der Schatten' (droppt von den Dämonen aus Winterspring oder den Verwüstende Lande) kombinierst, für Segnung, ein epischer Priestergegenstand.";
...
L["Quest_6163_Location"] = "Nathanos Blightcaller (Östliche Pestländer; "..YELLOW.."22.8, 68.0"..PREV..")";
L["Quest_6163_Note"] = "Du bekommst die Vorquest ebenfalls von Nathanos Blightcaller. Du findest Ramstein bei "..YELLOW.."[18]"..PREV..".";
L["Quest_6163_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_1475_Location"] = "Brohann Caskbelly (Stormwind - Zwergendistrikt; "..YELLOW.."69.5, 40.4"..PREV..")";
...
L["Quest_3445_Location"] = "Angelas Moonbreeze (Feralas - Festung Feathermoon; "..YELLOW.."31,45"..PREV..")";
L["Quest_3445_Note"] = "Du findest Marvon Rivetseeker bei "..YELLOW.."52,45"..PREV..".";
...
L["Quest_3446_Location"] = "Marvon Rivetseeker (Tanaris; "..YELLOW.."52,45"..PREV..")";
L["Quest_3446_Note"] = "Der Altar ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_3447_Location"] = "Marvon Rivetseeker (Tanaris; "..YELLOW.."52,45"..PREV..")";
L["Quest_3447_Note"] = "Du findest die Statue bei "..YELLOW.."[1]"..PREV..". Siehe Karte für die Reihenfolge, um sie zu aktivieren.";
...
L["Quest_4143_Location"] = "Gregan Brewspewer (Feralas; "..YELLOW.."45,25"..PREV..")";
L["Quest_4143_Note"] = "Die Vorquest 'Muigin und Larion' startet bei Muigin (Un'Goro Krater - Marshals Zuflucht; "..YELLOW.."42,9"..PREV.."). Du bekommst den Dunst von den Tieflauerern, Düsterwürmern oder Brühschlammern.";
...
L["Quest_1446_Location"] = "Verbannter der Atal'ai (Hinterland; "..YELLOW.."33,75"..PREV..")";
L["Quest_1446_Note"] = "Du findest Jammal'an bei "..YELLOW.."[4]"..PREV..".";
L["Quest_1446_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_3373_Location"] = "Die Essenz des Eranikus (droppt vom Schatten des Eranikus; "..YELLOW.."[6]"..PREV..")";
L["Quest_3373_Note"] = "Du findest die Essenz an dem Schatten von Eranikus bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_8422_Location"] = "Impsy (Felwood; "..YELLOW.."42,45"..PREV..")";
...
L["Quest_8422_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8425_Location"] = "Gefallenen Helden der Horde (Sümpfe des Elends; "..YELLOW.."34,66"..PREV..")";
...
L["Quest_8425_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_9053_Location"] = "Torwa Pathfinder (Un'Goro-Krater; "..YELLOW.."72,76"..PREV..")";
L["Quest_9053_Note"] = "Druidenquest. Die Fäulnissranke droppt von Atal'alarion der bei "..YELLOW.."[1]"..PREV.." erscheint, durch Aktivieren der Statuen in der auf der Karte angegebenen Reihenfolge.";
L["Quest_9053_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8232_Location"] = "Ogtinc (Azshara; "..YELLOW.."42,43"..PREV..")";
L["Quest_8232_Note"] = "Jägerquest. Morphaz ist bei "..YELLOW.."[5]"..PREV..".";
L["Quest_8232_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8253_Location"] = "Erzmagier Xylem (Azshara; "..YELLOW.."29,40"..PREV..")";
L["Quest_8253_Note"] = "Magierquest. Morphaz ist bei "..YELLOW.."[5]"..PREV..".";
L["Quest_8253_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8257_Location"] = "Ogtinc (Azshara; "..YELLOW.."42,43"..PREV..")";
L["Quest_8257_Note"] = "Priesterquest. Morphaz ist bei "..YELLOW.."[5]"..PREV..". Greta Mosshoof ist bei Teufelswald - Smaragdgrüne Heiligtum ("..YELLOW.."51,82"..PREV..").";
L["Quest_8257_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8236_Location"] = "Erzmagier Xylem (Azshara; "..YELLOW.."29,40"..PREV..")";
L["Quest_8236_Note"] = "Schurkenquest. der azurblaue Schlüssel droppt von Morphaz bei "..YELLOW.."[5]"..PREV..". Lord Jorach Rabenholdt ist bei Alteracgebirge - Rabenholdt ("..YELLOW.."86,79"..PREV..").";
L["Quest_8236_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8418_Location"] = "Kommandant Ashlam Valorfist (Westliche Pestländer - Chillwind Lager; "..YELLOW.."43,85"..PREV..")";
...
L["Quest_8418_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_1445_Location"] = "Fel'Zerul (Sümpfe des Elends - Stonard; "..YELLOW.."47,54"..PREV..")";
...
L["Quest_3380_Location"] = "Hexendoktor Uzer'i (Feralas; "..YELLOW.."74,43"..PREV..")";
L["Quest_3380_Note"] = "Du findest Marvon Rivetseeker bei "..YELLOW.."52,45"..PREV..".";
...
L["Quest_4146_Location"] = "Liv Rizzlefix (Brachland; "..YELLOW.."62,38"..PREV..")";
L["Quest_4146_Note"] = "Die Vorquest 'Larion und Muigin' startet bei Larion (Un'Goro-Krater; "..YELLOW.."45,8"..PREV.."). Du bekommst den Dunst von den Brühschlammern, Düsterwürmern oder Tieflauerern.";
...
L["Quest_8413_Location"] = "Bath'rah the Windbehüter (Alteracgebirge; "..YELLOW.."80,67"..PREV..")";
...
L["Quest_8413_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_721_Location"] = "Ausgrabungsleiter Ryedol (Ödland; "..YELLOW.."53,43"..PREV..")";
L["Quest_721_Note"] = "Die Vorquest startet mit der zerknittere Karte (Ödland; "..YELLOW.."53,33"..PREV..").\nDu findest Hammertoe Grez bevor Du die Instanze betretets bei "..YELLOW.."[1]"..PREV.." auf der Eingangskarte.";
...
L["Quest_722_Location"] = "Hammertoe Grez (Uldaman; "..YELLOW.."[1] auf der Eingangskarte"..PREV..").";
L["Quest_722_Note"] = "Das Amulett droppt von Magregan Deepshadow bei "..YELLOW.."[2] auf der Eingangskarte"..PREV..".";
...
L["Quest_1139_Location"] = "Berater Belgrum (Ironforge - Hallr der Forscher; "..YELLOW.."77,10"..PREV..")";
L["Quest_1139_Note"] = "Die Tafel ist bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_704_Location"] = "Ausgrabungsleiter Ironband (Loch Modan - Ironbands Ausgrabungsstätte; "..YELLOW.."65,65"..PREV..")";
L["Quest_704_Note"] = "Die Vorquest startet bei Ausgrabungsleiter Stormpike (Ironforge - Halle der Forscher; "..YELLOW.."74,12"..PREV..").\nDie Urnen sind in der Höhle vor der Instanz verstreut.";
...
L["Quest_709_Location"] = "Theldurin der Verirrte (Ödland; "..YELLOW.."51,76"..PREV..")";
...
L["Quest_2398_Location"] = "Ausgrabungsleiter Stormpike (Ironforge - Halle der Forscher; "..YELLOW.."75,12"..PREV..")";
L["Quest_2398_Note"] = "Baelog ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_2240_Location"] = "Baelog (Uldaman; "..YELLOW.."[1]"..PREV..")";
L["Quest_2240_Note"] = "Die geheime Kammer ist bei "..YELLOW.."[4]"..PREV..". Um die geheime Kammer zu öffnen brauchst Du den Stab von Tsol von Revelosh "..YELLOW.."[3]"..PREV.." und das Gni'kiv Medaillon von der Brust Baelog "..YELLOW.."[1]"..PREV..". Kombiniere diese beiden Gegenstände, um den Stab der Prähistorie zu bilden. Der Stab wird im Kartenraum eingesetzt zwischen "..YELLOW.."[3] und [4]"..PREV.." um Ironaya zu beschwören. Nachdem du sie getötet hast, laufe in den Raum, aus dem sie kam, um die Questbelohnung zu erhalten.";
L["Quest_2240_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_2198_Note"] = "Bring die zerissene Halskette zu Talvash del Kissel (Ironforge - Mystikerviertel; "..YELLOW.."36,3"..PREV..").";
...
L["Quest_2200_Location"] = "Talvash del Kissel (Ironforge - Mystikerviertel; "..YELLOW.."36,3"..PREV..")";
L["Quest_2200_Note"] = "Der Paladin ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2201_Location"] = "Überreste eines Paladins (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2201_Note"] = "Die Edelsteine sind bei "..YELLOW.."[1]"..PREV.." in einer auffälligen Urne., "..YELLOW.."[8]"..PREV.." von der Schattenschmiede, und "..YELLOW.."[9]"..PREV.." von Grimlok. Beachte, wenn die Schattenschmiede geöffnet wird, erscheinen einige Gegner die Dich sofort angreifen.\nBenutze Talvashs Wahrsageschale um die Quest zu beenden und die Folgequest zu erhalten.";
...
L["Quest_2204_Note"] = "Die Kraftquelle droppt von Archaedas bei "..YELLOW.."[10]"..PREV..".";
...
L["Quest_17_Location"] = "Ghak Healtouch (Loch Modan - Thelsamar; "..YELLOW.."37,49"..PREV..")";
...
L["Quest_1360_Location"] = "Krom Stoutarm (Ironforge - Halle der Forscher; "..YELLOW.."74,9"..PREV..")";
...
L["Quest_2278_Location"] = "Die Scheiben von Norgannon (Uldaman; "..YELLOW.."[11]"..PREV..")";
L["Quest_2278_Note"] = "Nachdem du die Quest erhalten hast, sprich mit dem Steinbeobachter links von der Scheibe.  Dann benutze die Platinscheibe wieder, um Miniaturscheibe zu erhalten und bringe diese zu Sage Truthseeker in Thunder Bluff ("..YELLOW.."34,46"..PREV.."). Die Folgequest erälst Du von einem NPC in der Nähe.";
L["Quest_2278_RewardText"] = WHITE.."1"..AQ_AND.."2(x5)"..AQ_OR.."3(x5)";
...
L["Quest_1956_Location"] = "Tabetha (Marschen von Dustwallow; "..YELLOW.."46,57"..PREV..")";
L["Quest_1956_Note"] = "Magierquest!\nDie Obsidiankraftquelle droppt von der Obsidianschildwache bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_1192_Location"] = "Pozzik (Tausend Nadeln - Mirage Raceway; "..YELLOW.."80.1, 75.9"..PREV..")";
...
L["Quest_2283_Location"] = "Dran Droffers (Orgrimmar - Die Gasse; "..YELLOW.."59,36"..PREV..")";
...
L["Quest_2284_Location"] = "Dran Droffers (Orgrimmar - Die Gasse; "..YELLOW.."59,36"..PREV..")";
L["Quest_2284_Note"] = "Der Paladin ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2318_Location"] = "Überreste eines Paladins (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2318_Note"] = "Der Übersetzer Jarkal Mossmeld ist in Kargath (Ödland; "..YELLOW.."2,46"..PREV..").";
...
L["Quest_2339_Location"] = "Jarkal Mossmeld (Ödland - Kargath; "..YELLOW.."2,46"..PREV..")";
L["Quest_2339_Note"] = "Die Edelsteine sind bei "..YELLOW.."[1]"..PREV.." in einer auffälligen Urne., "..YELLOW.."[8]"..PREV.." von der Schattenschmiede, und "..YELLOW.."[9]"..PREV.." von Grimlok. Beachte, wenn die Schattenschmiede geöffnet wird, erscheinen einige Gegner die Dich sofort angreifen Die Kraftquelle der zerbrochenen Halskette droppt von Archaedas "..YELLOW.."[10]"..PREV..".";
...
L["Quest_2202_Location"] = "Jarkal Mossmeld (Ödland - Kargath; "..YELLOW.."2,69"..PREV..")";
...
L["Quest_2342_Location"] = "Patrick Garrett (Undercity; "..YELLOW.."72,48"..PREV..")";
L["Quest_2342_Note"] = "Du findest die Truhe bevor Du die Instanz betritts. Es ist am Ende des südlichen Tunnels auf der Eingangskarte "..YELLOW.."[5]"..PREV..".";

L["Quest_971_Name"] = "Wissen in der Tiefe";
L["Quest_971_Objective"] = "Bringt das 'Lorgalis-Manuskript' zu Gerrig Bonegrip in Ironforge.";
L["Quest_971_Location"] = "Gerrig Bonegrip (Ironforge - Das Düstere Viertel; "..YELLOW.."50,5"..PREV..")";
L["Quest_971_Note"] = "Das Mansukript findest Du bei "..YELLOW.."[2]"..PREV.." im Wasser.";
...
L["Quest_1275_Location"] = "Gershala Nightwhisper (Dunkelküste - Auberdine; "..YELLOW.."38,43"..PREV..")";
L["Quest_1275_Note"] = "Die Vorquest ist optional.Diese bekommst Du von Argos Nightwhisper bei (Stormwind - Der Park; "..YELLOW.."35.9, 67.3"..PREV.."). \n\nAlle Nagas vor und in der Instanz droppen die Gehirne.";
L["Quest_1275_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_1198_Location"] = "Dämmerungsbehüter Shaedlass (Darnassus - Terrasse der Handwerker; "..YELLOW.."55,24"..PREV..")";
L["Quest_1198_Note"] = "Du findest Argentumwache Thaelrid bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_1200_Location"] = "Argentumwache Thaelrid (Blackfathom-Tiefe; "..YELLOW.."[4]"..PREV..")";
L["Quest_1200_Note"] = "Twilight Lord Kelris ist bei "..YELLOW.."[8]"..PREV..". Du findest Dämmerungsbehüter Selgorm in Darnassus - Terrasse der Handwerker ("..YELLOW.."55,24"..PREV.."). \n\nACHTUNG! Wenn du die kleinen Flammen an den Seiten der Säule betritts, erscheinen Feinde.";
L["Quest_1200_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_1199_Location"] = "Argentumwache Manados (Darnassus - Terrasse der Handwerker; "..YELLOW.."55,23"..PREV..")";
L["Quest_1199_Note"] = "Jeder Twilight Gegner können die Anhänger fallen lassen.";
L["Quest_1199_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_6563_Location"] = "Je'neu Sancrea (Ashenvale - Zoram'gar Außénposten; "..YELLOW.."11,33"..PREV..")";
L["Quest_6563_Note"] = "Du bekommst die Vorquest von Tsunaman (Steinkrallengebirge - Sonnenfels; "..YELLOW.."47,64"..PREV.."). Die Kristalle findest Du im Tunnel vor der Instanze.";
...
L["Quest_6564_Note"] = "Du bekommst die feuchte Notiz von den Blackfathom Gezeitenpriesterinen (5% drop Chance). Dies bringt Dich zu Je'neu Sancrea (Ashenvale - Zoram'gar Außenposten; "..YELLOW.."11,33"..PREV.."). Lorgus Jett ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_6564_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_6921_Location"] = "Je'neu Sancrea (Ashenvale - Zoram'gar Außenposten; "..YELLOW.."11,33"..PREV..")";
L["Quest_6921_Note"] = "Du findest den Fathom-Kern bei "..YELLOW.."[7]"..PREV.." im Wasser. Wenn Du den Kern bekommst, erscheint Baron Aquanis und greift dich an. Er droppt den Questgegenstand was Du brauchst um zu Je'neu Sancrea zurückzukehren.";
...
L["Quest_6561_Location"] = "Argentumwache Thaelrid (Blackfathom-Tiefe; "..YELLOW.."[4]"..PREV..")";
L["Quest_6561_Note"] = "Twilight Lord Kelris ist bei "..YELLOW.."[8]"..PREV..". Du findest Bashana Runetotem in Thunder Bluff - Anhöhe der Ältesten ("..YELLOW.."70,33"..PREV.."). \n\nACHTUNG! Wenn du die kleinen Flammen an den Seiten der Säule betritts, erscheinen Feinde.";
L["Quest_6561_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7441_Location"] = "Azj'Tordin (Feralas - Lariss Pavillion; "..YELLOW.."76,37"..PREV..")";
L["Quest_7441_Note"] = "Pusillin ist in Düsterbruch "..YELLOW.."Ost"..PREV.." at "..YELLOW.."[1]"..PREV..". Er rennt, wenn du mit ihm redest, aber stoppt und kämpft bei "..YELLOW.."[2]"..PREV..". Er droppt den Halbmondschlüssel, der für Düsterbruch Nord und West benutzt wird.";
L["Quest_7441_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7488_Location"] = "Latronicus Moonspear (Feralas - Festung Feathermoon; "..YELLOW.."30,46"..PREV..")";
L["Quest_7488_Note"] = "Lethtendris ist in Düsterbruch "..YELLOW.."Ost"..PREV.." bei "..YELLOW.."[3]"..PREV..". Die Vorquest stammt vom Kurier Hammerfall in Ironforge. Er durchstreift die ganze Stadt.";
...
L["Quest_5526_Location"] = "Rabine Saturna (Moonglade - Nighthaven; "..YELLOW.."51,44"..PREV..")";
L["Quest_5526_Note"] = "Du findest Alliz der Wildformer in Düsterbruch"..YELLOW.."Ost"..PREV.." bei "..YELLOW.."[5]"..PREV..". Das Relikt ist in Silithius bei "..YELLOW.."62,54"..PREV..". Die Vorquest stratet ebenfalls beim selben NPC.";
L["Quest_5526_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_8990_Location"] = "Bodley (Schwarzfels; "..YELLOW.."[D] auf der Eingangskarte"..PREV..")";
...
L["Quest_8990_FollowQuest"] = "Letzte Vorbereitungen ("..YELLOW.."Obere Schwarzfelsspitze"..PREV..")";
...
L["Quest_7489_Location"] = "Talo Thornhoof (Feralas - Camp Mojache; "..YELLOW.."76,43"..PREV..")";
L["Quest_7489_Note"] = "Lethtendris ist in Düsterbruch "..YELLOW.."Ost"..PREV.." bei "..YELLOW.."[3]"..PREV..". Die Vorquest stammt von Kriegsrufer Gorlach in Orgrimmar. Er durchstreift die ganze Stadt.";
...
L["Quest_1193_Location"] = "Eine beschädigte Falle (Düsterbruch; "..YELLOW.."Nord"..PREV..")";
...
L["Quest_5518_Location"] = "Knot Thimblejack (Düsterbruch; "..YELLOW.."Nord, [4]"..PREV..")";
L["Quest_5518_Note"] = "Wiederholbare Quest. Du bekommst das Ogergerbemittel nähe "..YELLOW.."[4] (oben)"..PREV..".";
...
L["Quest_5525_Location"] = "Knot Thimblejack (Düsterbruch; "..YELLOW.."Nord, [4]"..PREV..")";
...
L["Quest_7703_Location"] = "Captain Kromcrush (Düsterbruch; "..YELLOW.."Nord, [5]"..PREV..")";
L["Quest_7703_Note"] = "Prinz ist in Düsterbruch "..YELLOW.."West"..PREV.." bei "..YELLOW.."[7]"..PREV..". Die Stulpen sind in der Nähe in einer Truhe. Du kannst diese Quest nur machen, nachdem Du den Tributlauf gemacht hast und den Königsbuff der Gordok besitzt.";
L["Quest_7703_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_5528_Name"] = "Der Gordokgeschmackstest";
L["Quest_5528_Objective"] = "Kostenloser Alkohol.";
L["Quest_5528_Location"] = "Stampfer Kreeg (Düsterbruch; "..YELLOW.."Nord, [2]"..PREV..")";
...
L["Quest_5528_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_7482_Location"] = "Gelehrter Runethorn (Feralas - Festung Feathermoon; "..YELLOW.."31,43"..PREV..")";
L["Quest_7482_Note"] = "Du findest Kariel Winthalus in der "..YELLOW.."Bibliothek (West)"..PREV..".";
...
L["Quest_7461_Location"] = "Uralte Shen'dralar (Düsterbruch; "..YELLOW.."West, [1] (Oben)"..PREV..")";
L["Quest_7461_Note"] = "Die Pylonen sind markiert als "..BLUE.."[B]"..PREV..". Immol'thar ist bei "..YELLOW.."[6]"..PREV..", Prinze Tortheldrin bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7877_Location"] = "Uralte Shen'dralar (Düsterbruch; "..YELLOW.."West, [1]"..PREV..")";
L["Quest_7877_Note"] = "Du findest den Schatz unterhalb des Treppenaufgangs "..YELLOW.."[7]"..PREV..".";
L["Quest_7877_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7631_Location"] = "Mor'zul Bloodbringer (Brennende Steppe; "..YELLOW.."12,31"..PREV..")";
L["Quest_7631_Note"] = "Finale Quest für das Eische Reittier des Hexenmeisters. Zuerst musst du alle mit "..BLUE.."[B]"..PREV.." markierten Pylone abschalten und dann töte Immol'thar bei "..YELLOW.."[6]"..PREV..".Danach kannst du mit dem Beschwörungsritual beginnen. Stelle sicher, dass du mehr als 20 Seelensplitter hast und einen Hexenmeister hast, der speziell dafür vorgesehen ist, die Glocke, die Kerze und das Rad oben zu halten. Die kommenden Schicksalsgarden können versklavt werden. Sprich nach Abschluss mit dem Schreckensrossgeist, um die Quest abzuschließen.";
L["Quest_7631_PreQuest"] = "Wichtellieferung ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_7506_Note"] = "Die Belohnung sind für Druiden. Du gibst das Buch bei Hüter des Wissens Javon in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7503_Note"] = "Die Belohnung sind für Jäger. Du gibst das Buch bei Hüterin des Wissens Mykos in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7500_Note"] = "Die Belohnung sind für Magier. Du gibst das Buch bei Lorekeeper Kildrath at the "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7501_Note"] = "Die Belohnung sind für Paladine. Du gibst das Buch bei Hüterin des Wissens Mykos in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7504_Note"] = "Die Belohnung sind für Priester. Du gibst das Buch bei Hüter des Wissens Javon in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7498_Note"] = "Die Belohnung sind für Schurken. Du gibst das Buch bei Lorekeeper Kildrath at the "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7502_Note"] = "Die Belohnung sind für Hexenmeister. Du gibst das Buch bei Hüterin des Wissens Mykos in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7499_Note"] = "Die Belohnung sind für Krieger. Du gibst das Buch bei Hüter des Wissens Kildrath in der "..YELLOW.."1' Bibliothek"..PREV.." ab.";
...
L["Quest_7484_Location"] = "Hüter des Wissens Lydros (Düsterbruch West; "..YELLOW.."[1'] Bibliothek"..PREV..")";
L["Quest_7484_Note"] = "Es gibt keine Vorquest, doch die Quest 'Elfische Legenden' muss vorher abgeschlossen werden.\n\nDas Buchband ist ein zufälliger dropp in Düsterbruch und ist handelbar, so dass es im Auktionshaus zu finden ist. Schattenhaut ist sellengebunden und Kann von den Gegnern: Auferstandenes Konstrukt und Auferstandener Knochenwärter in "..YELLOW.."Scholomance"..PREV.." gedroppt werden.";
...
L["Quest_7483_Location"] = "Hüter des Wissens Lydros (Düsterbruch West; "..YELLOW.."[1'] Bibliothek"..PREV..")";
...
L["Quest_7507_Location"] = "Forors Kompendium des Drachentötens (zufälliger dropp  in "..YELLOW.."Düsterbruch"..PREV..")";
L["Quest_7507_Note"] = "Kriegerquest. Die bringt Dich zu Hüter des Wissens Lydros in (Düsterbruch West; "..YELLOW.."[1'] Bibliothek"..PREV.."). Wenn du dies aktivierst, kannst du die Quest für Quel'Serrar beginnen.";
...
L["Quest_7481_Location"] = "Sage Korolusk (Feralas - Camp Mojache; "..YELLOW.."74,43"..PREV..")";
L["Quest_7481_Note"] = "Du findest Kariel Winthalus in der "..YELLOW.."Bibliothek (West)"..PREV..".";
...
L["Quest_7505_Note"] = "Die Belohnung sind für Schamanen. Du gibst das Buch bei Hüter des Wissens Javon in der "..GREEN.."[1'] Bibliothek"..PREV.." ab.";
...
L["Quest_7070_Location"] = "Erzmagier Tervosh (Marschen von Dustwallow - Insel Theramore "..YELLOW.."66,49"..PREV..")";
...
L["Quest_7070_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7041_Location"] = "Talendria (Desolace - Nijelspitze; "..YELLOW.."68,8"..PREV..")";
...
L["Quest_7041_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7028_Location"] = "Willow (Desolace; "..YELLOW.."62,39"..PREV..")";
L["Quest_7028_Note"] = "Die meisten Gegner droppen die Schnitzereien.";
L["Quest_7028_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_7067_Location"] = "Zentaurenpariah (Desolace; "..YELLOW.."45,86"..PREV..")";
L["Quest_7067_Note"] = "Töte den Namenlosen Propheten bei ("..YELLOW.."[A] auf der Eingangskarte"..PREV..") und dann töte den 5. Kahns.  Der erste ist im mittleren Pfad in der Nähe von ("..YELLOW.."[D] auf der Eingangskarte"..PREV..").  Der zweite ist im lilafarbenen Teil von Maraudon, aber bevor Du die Dungeon betrittst ("..YELLOW.."[B] auf der Eingangskarte"..PREV..").  Der Dritte befindet sich im orangefarbenen Teil, bevor du die Instanz betrittst ("..YELLOW.."[C] auf der Eingangskarte"..PREV..").  Der Vierte ist in der Nähe von "..YELLOW.."[4]"..PREV.." und der Fünfte ist in der Nähe von  "..YELLOW.."[1]"..PREV..".";
L["Quest_7067_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_7044_Location"] = "Cavindra (Desolace - Maraudon; "..YELLOW.."[4] auf der Eingangskarte"..PREV..")";
L["Quest_7044_Note"] = "Du findest Cavindra am Anfang des orangefarbenen Teils, bevor du die Instanz betrittst.\nDu bekommst denn Celebriangriff von Noxxion bei "..YELLOW.."[2]"..PREV..", den Celebriandiamanten von Lord Vyletongue bei  "..YELLOW.."[5]"..PREV..". Celebras ist bei "..YELLOW.."[7]"..PREV..". Du mußt ihn besiegen, um mit ihm reden zu können.";
...
L["Quest_7046_Location"] = "Celebras der Erlöste (Maraudon; "..YELLOW.."[7]"..PREV..")";
...
L["Quest_7065_Location"] = "Bewahrer Marandis (Desolace - Nijelspitze; "..YELLOW.."63,10"..PREV..")";
L["Quest_7065_Note"] = "Du findest Prinzessin Theradras bei "..YELLOW.."[11]"..PREV..".";
L["Quest_7065_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7066_Location"] = "Zaetars Geist (Maraudon; "..YELLOW.."[11]"..PREV..")";
L["Quest_7066_Note"] = "Zaetars Geist erscheint nach dem Tod von Prinzessin Theradras "..YELLOW.."[11]"..PREV..". Du findest Bewahrer Remulos bei (Moonglade - Schrein von Remulos; "..YELLOW.."36,41"..PREV..").";
...
L["Quest_7068_Location"] = "Uthel'nay (Orgrimmar - Tal der Geister; "..YELLOW.."39,86"..PREV..")";
...
L["Quest_7068_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7029_Location"] = "Vark Battlescar (Desolace - Shadowprey Village; "..YELLOW.."23,70"..PREV..")";
...
L["Quest_7029_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7064_Location"] = "Selendra (Desolace; "..YELLOW.."27,77"..PREV..")";
L["Quest_7064_Note"] = "Du findest Prinzessin Theradras bei "..YELLOW.."[11]"..PREV..".";
L["Quest_7064_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_5723_Location"] = "Rahauro (Thunder Bluff - Anhöhe der Ältesten; "..YELLOW.."70,29"..PREV..")";
...
L["Quest_5725_Location"] = "Varimathras (Undercity - Königliches Quartier; "..YELLOW.."56,92"..PREV..")";
L["Quest_5725_Note"] = "Sengende Klingenkultisten und Hexenmeister lassen die Bücher fallen.";
L["Quest_5725_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_5722_Location"] = "Rahauro (Thunder Bluff - Anhöhe der Ältesten; "..YELLOW.."70,29"..PREV..")";
L["Quest_5722_Note"] = "Du findest Maur Grimtotem bei "..YELLOW.."[1]"..PREV..". Nachdem du die Tasche erhalten hast, bringe diese zurück zu Rahauro in Thunder Bluff";
L["Quest_5722_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_5728_Location"] = "Thrall (Orgrimmar - Tal der Weisheit; "..YELLOW.."31,37"..PREV..")";
L["Quest_5728_Note"] = "Du findest Bazzalan bei  "..YELLOW.."[4]"..PREV.." und Jergosh bei "..YELLOW.."[3]"..PREV..". Die Questreihe startet bei Kriegshäuptling Thrall in Orgrimmar.";
L["Quest_5728_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5761_Location"] = "Neeru Fireblade (Orgrimmar - Kluft der Schatten; "..YELLOW.."49,50"..PREV..")";
L["Quest_5761_Note"] = "Du findest Taragaman bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6626_Location"] = "Myriam Moonsinger (Brachland; "..YELLOW.."49,94"..PREV..")";
...
L["Quest_3525_Location"] = "Belnistrasz (Die Hügel der Razforzen; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_3636_Location"] = "Erzbischof Benedictus (Stormwind - Kathedrale des Lichts; "..YELLOW.."50.0, 45.4"..PREV..")";
L["Quest_3636_Note"] = "Amnennar den Kältebringer ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_3636_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_6521_Location"] = "Varimathras (Undercity - Königliches Quartier; "..YELLOW.."56,92"..PREV..")";
L["Quest_6521_Note"] = "Die vorhergehende Quest kann vom letzten Boss erhalten werden. Du findest Malcin außerhalb (Brachland; "..YELLOW.."48,92"..PREV..").";
L["Quest_6521_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_3341_Location"] = "Andrew Brownell (Undercity - Das Magierviertel; "..YELLOW.."72,32"..PREV..")";
L["Quest_3341_Note"] = "Amnennar den Kältebringer ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_3341_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_1221_Location"] = "Mebok Mizzyrix (Brachland - Ratchet; "..YELLOW.."62,37"..PREV..")";
...
L["Quest_1142_Location"] = "Heraltha Fallowbrook (Kral der Razforzen; "..YELLOW.."[8]"..PREV..")";
L["Quest_1142_Note"] = "Der Anhänger ist ein zufälliger Drop. Du musst den Anhänger zum Treshala Fallowbrook in Darnassus zurückbringen - Terrasse der Händler ("..YELLOW.."69,67"..PREV..").";
L["Quest_1142_RewardText"] = WHITE.."1"..AQ_OR.."2";

L["Quest_1144_Name"] = "Willix der Importeur";
L["Quest_1144_Objective"] = "Führt Willix den Importeur aus dem Kral von Razorfen hinaus.";
L["Quest_1144_Location"] = "Willix der Importeur (Kral der Razforzen; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_1144_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1101_Location"] = "Falfindel Waywarder (Feralas - Thalanaar; "..YELLOW.."89,46"..PREV..")";
L["Quest_1101_Note"] = "Charlga Razorflank "..YELLOW.."[7]"..PREV.." droppt das Medaillon, das für diese Aufgabe benötigt wird.";
L["Quest_1101_RewardText"] = WHITE.."1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_1701_Location"] = "Furen Longbeard (Stormwind - Zwergendistrikt; "..YELLOW.."64.4, 37.3"..PREV..")";
L["Quest_1701_Note"] = "Diese Quest können nur Krieger erhalten. Du bekommst die Phiole von Roogug bei "..YELLOW.."[1]"..PREV..".\n\nDie Folgequest ist für jeden Rasse unterschiedlich. Brennendes Blut für Menschen, Eisenkoralle für Zwerge und Gnome und Sonnenverbrannte Schalen für Nachtelfen.";
...
L["Quest_1109_Location"] = "Apothekenmeister Faranell (Undercity - Das Apothekarium; "..YELLOW.."48,69 "..PREV..")";
L["Quest_1109_Note"] = "Kraul Guano wird von jeder der Fledermäuse fallen gelassen, die in der Instanz gefunden werden.";
L["Quest_1109_FollowQuest"] = "Herzen des Eifers ("..YELLOW.."[Scharlachroter Kloster"..PREV..")";
...
L["Quest_1102_Location"] = "Auld Stonespire (Thunderbluff; "..YELLOW.."36,59"..PREV..")";
L["Quest_1102_Note"] = "Du findest Charlga Razorflank bei "..YELLOW.."[7]"..PREV..".";
L["Quest_1102_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1838_Location"] = "Thun'grim Firegaze (Brachland; "..YELLOW.."57,30"..PREV..")";
L["Quest_1838_Note"] = "Diese Quest können nur Krieger erhalten. Du bekommst die Phiole von Roogug bei "..YELLOW.."[1]"..PREV..".\n\nWenn du diese Quest abschließt, kannst du vier neue Quests vom gleichen NPC starten.";
...
L["Quest_1486_Location"] = "Nalpak (Brachland - Wailing Caverns; "..YELLOW.."47,36"..PREV..")";
...
L["Quest_1486_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_959_Location"] = "Kranführer Bigglefuzz (Brachland - Ratchet; "..YELLOW.."63,37"..PREV..")";
L["Quest_959_Note"] = "Du bekommst die Flasche kurz bevor du in die Instanz gehst, indem du Mad Magglish tötest. Wenn du das erste Mal die Höhle betrittst, biege sofort rechts ab, um ihn am Ende des Ganges zu finden. Er ist getarnt an der Mauer bei "..YELLOW.."[2] auf der Eingangskarte"..PREV..".";

L["Quest_1491_Name"] = "Klugheitstränke";
L["Quest_1491_Objective"] = "Bringt 6 Portionen Klageessenz zu Mebok Mizzyrix in Ratchet.";
L["Quest_1491_Location"] = "Mebok Mizzyrix (Brachland - Ratchet; "..YELLOW.."62,37"..PREV..")";
...
L["Quest_1487_Location"] = "Ebru (Brachland - Die Höhlen des Wehklagens; "..YELLOW.."47,36"..PREV..")";
...
L["Quest_1487_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_6981_Location"] = "Leuchtender Splitter (droppt von Mutanus der Verschlinger bei ; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_6981_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_962_Location"] = "Apothekerin Zamah (Thunder Bluff - Anhöhe der Geister; "..YELLOW.."22,20"..PREV..")";
L["Quest_962_Note"] = "Apothekerin Zamah ist in einer Höhle unter der Anhöge der Geister.  Du bekommst die Vorquest von Apothekerin Helbrim (Brachland - Crossroads; "..YELLOW.."51,30"..PREV..").\nDu bekommst den Schlangenfaum innerhalb der Höhle vor und in der Instanz. Spieler mit Kräuterkunde können die Pflanzen auf ihrer Minimap sehen.";
...
L["Quest_914_Location"] = "Nara Wildmane (Thunder Bluff - Anhöe der Ältesten Rise; "..YELLOW.."75,31"..PREV..")";
L["Quest_914_Note"] = "Die Questreihe startet bei Hamuul Runetotem (Thunderbluff - Elder Rise; "..YELLOW.."78,28"..PREV..")\nDie 4 Druiden droppen die Edelsteine bei "..YELLOW.."[2]"..PREV..", und "..YELLOW.."[3]"..PREV..", und "..YELLOW.."[5]"..PREV..", und "..YELLOW.."[7]"..PREV..".";
L["Quest_914_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_3042_Location"] = "Trenton Lighthammer (Tanaris - Gadgetzan; "..YELLOW.."51,28"..PREV..")";
...
L["Quest_2865_Location"] = "Tran'rek (Tanaris - Gadgetzan; "..YELLOW.."51,26"..PREV..")";
L["Quest_2865_Note"] = "Die Vorquest startet bei Krazek (Schlingendorntal - Booty Bay; "..YELLOW.."25,77"..PREV..").\nJeder Skarabäus kann die Schalen fallen lassen. Eine Menge Skarabäen sind bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2846_Location"] = "Tabetha (Marschen von Dustwallow; "..YELLOW.."46,57"..PREV..")";
L["Quest_2846_Note"] = "Wasserbeschwörerin Velratha droppt die Tiara der Tiefe bei "..YELLOW.."[6]"..PREV..".";
L["Quest_2846_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_2991_Location"] = "Thadius Grimshade (Verwüstete Lande - Burg Nethergarde ; "..YELLOW.."66,19"..PREV..")";
L["Quest_2991_Note"] = "Die Questreihe startet bei Greifenmeister Talonaxe (Hinterland - Wildhammer Stronghold; "..YELLOW.."9,44"..PREV..").\nNekrum erscheint bei "..YELLOW.."[4]"..PREV.." mit der letzten Gruppe, die du beim Tempel-Event bekämpfst.";
...
L["Quest_3527_Location"] = "Yeh'kinya (Tanaris - Steamwheedle Port; "..YELLOW.."66,22"..PREV..")";
L["Quest_3527_Note"] = "Du bekommst die Vorquest vom selben NPC.\nDie Tafeln droppen von Theka der Märtyrer bei "..YELLOW.."[2]"..PREV.." und Wasserbschwörerin Velratha bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_2768_Location"] = "Chefingenieur Bilgewhizzle (Tanaris - Gadgetzan; "..YELLOW.."52,28"..PREV..")";
L["Quest_2768_Note"] = "Du bekommst die Rute von Sergeant Bly. Du findest ihn bei "..YELLOW.."[4]"..PREV.." nach dem Tempel-Event.";
L["Quest_2768_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_2770_Location"] = "Wizzle Brassbolts (Tausend Nadeln - Mirage Raceway; "..YELLOW.."78,77"..PREV..")";
L["Quest_2770_Note"] = "Gahz'rilla erscheint bei "..YELLOW.."[6]"..PREV.." wenn du die Glocke schlägst. Ein Gruppenmitglied muss den Schlegel von Zul'Farrak haben.";
...
L["Quest_6822_Location"] = "Fürst Hydraxis (Azshara; "..YELLOW.."79,73"..PREV..")";
L["Quest_6822_Note"] = "Dies sind Nicht-Bosse, die sich im Inneren des geschmolzenen Kerns befinden.";
L["Quest_6822_PreQuest"] = "Auge des Glutsehers ("..YELLOW.."Obere Schwarzfelsspitze"..PREV..")";
...
L["Quest_6824_Location"] = "Fürst Hydraxis (Azshara; "..YELLOW.."79,73"..PREV..")";
L["Quest_6824_Note"] = "Lucifron ist bei "..YELLOW.."[1]"..PREV..", Sulfuron ist bei "..YELLOW.."[8]"..PREV..", Gehennas ist bei "..YELLOW.."[3]"..PREV.." und Shazzrah ist bei "..YELLOW.."[5]"..PREV..".\nDie Belohnungen bekommst Du mit der Folgequest.";
L["Quest_6824_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7786_Location"] = "Hochlord Demitrian (Silithus; "..YELLOW.."22,9"..PREV..")";
L["Quest_7786_Note"] = "Teil von der Donnernzorn, Gesegnete Klinge vonder Windseeker Questlreihe. Es beginnt, nachdem entweder die linke oder rechte Bindung des Windseekers von Garr bei "..YELLOW.."[4]"..PREV.." oder Baron Geddon bei "..YELLOW.."[6]"..PREV..". Dann spreche mit Hochlord Demitrian um die Questreihe zu beginnen Die Essence vom Feuerlord droppt von Ragnaros bei "..YELLOW.."[10]"..PREV..". Nachdem du diesen Teil abgegeben hast, wird Prinze Thunderaan erscheinen und Du musst ihn töten.";
...
L["Quest_7604_Location"] = "Lokhtos Darkbargainer (Schwarzfelstiefen; "..YELLOW.."[15]"..PREV..")";
L["Quest_7604_Note"] = "Du brauchst einen Sulfuronblock, um den Vertrag von Lokhtos zu bekommen. Diese droppt von Golemagg der Verbrenner im Geschmolzenen Kern bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7632_Location"] = "Uraltes versteinertes Blatt (droppt vom Behälter des Feuerfürsten; "..YELLOW.."[9]"..PREV..")";
L["Quest_7632_Note"] = "Kehrt zu Vartrus der Uralte zurück bei (Teufelswald - Eisenwald; "..YELLOW.."49,24"..PREV..").";
L["Quest_7632_FollowQuest"] = "Die passende Sehne -> Uraltes in Sehnen eingewickeltes Laminablatt ("..YELLOW.."Azuregos"..PREV..")";
...
L["Quest_8578_Location"] = "Unauffällige Kiste (Silberwald - Greymane-Wall; "..YELLOW.."46.2, 86.6"..PREV..")";
L["Quest_8578_Note"] = "Die Quest führt Dich zu Narain Soothfancy in (Tanaris - Steamwheedle "..YELLOW.."65.3, 18.6"..PREV.."), wo du auch die Vorquest erhältst.";
...
L["Quest_7509_Location"] = "Hüter des Wissens Lydros (Düsterbruch West; "..YELLOW.."[1] Bibliothek"..PREV..")";
...
L["Quest_7509_PreQuest"] = "Forors Kompendium ("..YELLOW.."Düsterbruch West"..PREV..") -> Das Schmieden von Quel'Serrar";
...
L["Quest_7495_Location"] = "Kopf von Onyxia (droppt von Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7495_Note"] = "Hochlord Bolvar Fordragon ist bei (Stormwind City - Burg Stormwind; "..YELLOW.."78,18"..PREV.."). Nur eine Person kann diesen Gegenstand plündern und die Quest kann nur einmal pro Charakter durchgeführt werden.\n\nBelohnung erhälst die in der Folgequest.";
L["Quest_7495_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7490_Location"] = "Kopf von Onyxia (droppt von Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7490_Note"] = "Thrall ist bei (Orgrimmar - Tal der Weisheit; "..YELLOW.."31,37"..PREV.."). Nur eine Person kann diesen Gegenstand plündern und die Quest kann nur einmal pro Charakter durchgeführt werden.\n\nBelohnung erhälst die in der Folgequest.";
L["Quest_7490_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8201_Location"] = "Exzhal (Schlingendorntal - Insel Yojamba; "..YELLOW.."15,15"..PREV..")";
L["Quest_8201_Note"] = "Stelle sicher, dass du alle Priester plünderst.";
L["Quest_8201_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_8183_Name"] = "Das Herz von Hakkar";
L["Quest_8183_Objective"] = "Bringt das Herz von Hakkar zu Molthor auf die Insel Yojamba. .";
L["Quest_8183_Location"] = "Herz von Hakkar (droppt von Hakkar; "..YELLOW.."[11]"..PREV..")";
L["Quest_8183_Note"] = "Molthor (Schlingendorntal - Insel Yojamba; "..YELLOW.."15,15"..PREV..")";
L["Quest_8183_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8227_Note"] = "Nat Pagle ist bei Marschen von Dustwallow ("..YELLOW.."59,60"..PREV.."). Wenn du die Quest abgeschlossen hast, kannst du Matschstinkerköder von Nat Pagle kaufen, um Gahz'ranka in Zul'Gurub zu beschwören.";
...
L["Quest_9023_Location"] = "Dirk Thunderwood (Silithus - Burg Cenarion; "..YELLOW.."52,39"..PREV..")";
L["Quest_9023_Note"] = "Venoxiss Giftbeutel droppt von Hohepriester Venoxis in "..YELLOW.."Zul'Gurub"..PREV.." bei "..YELLOW.."[2]"..PREV..". Kurinnaxxs Giftbeutel dropt in den "..YELLOW.."Ruinen von Ahn'Qiraj"..PREV.." bei "..YELLOW.."[1]"..PREV..".";
L["Quest_9023_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_OR.."6";
...
L["Quest_8791_Location"] = "Kopf von Ossirian dem Narbenlosen (droppt von Ossirian dem Narbenlosen; "..YELLOW.."[6]"..PREV..")";
L["Quest_8791_Note"] = "Kommandant Mar'alith (Silithus - Burg Cenarius; "..YELLOW.."49,34"..PREV..")";
L["Quest_8791_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_8801_Location"] = "Auge von C'Thun (droppt von C'Thun; "..YELLOW.."[9]"..PREV..")";
L["Quest_8801_Note"] = "Caelestrasz (Tempel von Ahn'Qiraj; "..YELLOW.."2'"..PREV..")";
...
L["Quest_8802_Location"] = "Auge von C'Thun (droppt von C'Thun; "..YELLOW.."[9]"..PREV..")";
L["Quest_8802_Note"] = "Anachronos (Tanaris - Höhlen der Zeit; "..YELLOW.."65,49"..PREV..")";
L["Quest_8802_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8784_Note"] = "Kehre zurück zu Andorgos (Tempel von Ahn'Qiraj; "..YELLOW.."1'"..PREV..").";
...
L["Quest_8579_Location"] = "Kandrostrasz (Tempel von Ahn'Qiraj; "..YELLOW.."[1']"..PREV..")";
...
L["Quest_7261_Location"] = "Lieutenant Rotimer (Ironforge - Das Bankenviertel; "..YELLOW.."30,62"..PREV..")";
L["Quest_7261_Note"] = "Lieutenant Haggerdin ist bei (Alteracgebirge; "..YELLOW.."39,81"..PREV..").";
...
L["Quest_7162_Location"] = "Lieutenant Haggerdin ist bei (Alteracgebirge; "..YELLOW.."39,81"..PREV..").";
L["Quest_7162_Note"] = "Das Banner der Stormpike ist in der Icewinghöhle bei "..YELLOW.."[11]"..PREV.." im Alteractal - Nord. Sprich jedes Mal mit demselben NPC, wenn du eine neue Rufstufe erreicht hast, für ein verbessertes Abzeichen erhältst.\n\nDie Prequest ist nicht notwendig, um diese Quest zu erhalten.";
L["Quest_7162_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7141_Location"] = "Ausgrabungsleiter Stonehewer (Alteracgebirge; "..YELLOW.."41,80"..PREV..") und\n(Alteractal - Nord; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "Drek'thar ist bei (Alteractal - Süd; "..YELLOW.."[B]"..PREV.."). Er muss nicht wirklich getötet werden, um die Quest zu beenden. Das Schlachtfeld muss nur auf irgendeine Art und Weise von deiner Seite gewonnen werden.\nNachdem du diese Quest abgegeben hast, sprich noch einmal mit dem NPC, um die Belohnung zu erhalten.";
L["Quest_7141_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_7121_Location"] = "Gebirgsjäger Boombellow (Alteractal - Nord; "..YELLOW.."Nähe [3] Vor der Brücke"..PREV..")";
L["Quest_7121_Note"] = "Der Rüstmeister der Stormpike ist bei (Alteractal - Nord; "..YELLOW.."[7]"..PREV..") und bietet mehr Quests.";
...
L["Quest_6982_Location"] = "Gebirgsjäger Boombellow (Alteractal - Nord; "..YELLOW.."Nähe [3] Vor der Brücke"..PREV..")";
L["Quest_6982_Note"] = "Die Vorräte befinden sich in der Coldtooth Mine bei (Alteractal - Süd; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_5892_Location"] = "Gebirgsjäger Boombellow (Alteractal - Nord; "..YELLOW.."Nähe [3] Vor der Brücke"..PREV..")";
L["Quest_5892_Note"] = "Die Vorräte befinden sich in der Irondeep-Mine bei (Alteractal - Nord; "..YELLOW.."[1]"..PREV..").";

L["Quest_7223_Name"] = "Rüstungsfetzen";
L["Quest_7223_Objective"] = "Bringt Murgot Deepforge in Dun Baldar 20 Rüstungsfetzen.";
L["Quest_7223_Location"] = "Murgot Deepforge (Alteractal - Nord; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_7122_Location"] = "Sergeant Durgen Stormpike (Alteracgebirge; "..YELLOW.."37,77"..PREV..")";
L["Quest_7122_Note"] = "Um die Quest zu beenden musst Du den Morloch in der Irondeep Mine bei (Alteractal - Nord; "..YELLOW.."[1]"..PREV..") oder Zuchtmeister Schnuffel in der Coldtooth Mine bei (Alteractal - Süd; "..YELLOW.."[6]"..PREV..") die unter der Kontrolle der Horde ist.";
...
L["Quest_7102_Location"] = "Sergeant Durgen Stormpike (Alteracgebirge; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7081_Location"] = "Sergeant Durgen Stormpike (Alteracgebirge; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7027_Location"] = "Stormpike Stallmeister (Alteractal - Nord; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7026_Location"] = "Kommandant der Stormpike-Widderreiter (Alteractal - Nord; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7386_Location"] = "Erzdruide Renferal (Alteractal - Nord; "..YELLOW.."[2]"..PREV..")";
L["Quest_7386_Note"] = "Nach dem abgeben von 200 Kristallen, wird Erzdruide Renferal beginnen sich Richtung (Alteractal - Nord; "..YELLOW.."[19]"..PREV..") zu bewegen. Dort angekommen, wird sie ein Beschwörungsritual beginnen, bei dem 10 Personen zur Unterstützung benötigt werden. Bei Erfolg, wird Ivus der Waldfürst herbeigerufen, um im Kampf zu helfen.";
...
L["Quest_6881_Location"] = "Erzdruide Renferal (Alteractal - Nord; "..YELLOW.."[2]"..PREV..")";
L["Quest_6881_Note"] = "Nach dem abgeben von 200 Kristallen, wird Erzdruide Renferal beginnen sich Richtung (Alteractal - Nord; "..YELLOW.."[19]"..PREV..") zu bewegen. Dort angekommen, wird sie ein Beschwörungsritual beginnen, bei dem 10 Personen zur Unterstützung benötigt werden. Bei Erfolg, wird Ivus der Waldfürst herbeigerufen, um im Kampf zu helfen.";
...
L["Quest_6942_Location"] = "Schwadronskommandant Slidore (Alteractal - Nord; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6941_Location"] = "Schwadronskommandant Vipore (Alteractal - Nord; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6943_Location"] = "Schwadronskommandant Ichman (Alteractal - Nord; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7241_Location"] = "Frostwolf Botschafter Rokhstrom (Orgrimmar - Tal der Stärke "..YELLOW.."50,71"..PREV..")";
L["Quest_7241_Note"] = "Kriegsmeister Laggrond ist bei (Alteracgebirge; "..YELLOW.."62,59"..PREV..").";
...
L["Quest_7161_Location"] = "Kriegsmeister Laggrond (Alteracgebirge; "..YELLOW.."62,59"..PREV..")";
L["Quest_7161_Note"] = "Der Frostwolf Banner ist in der Höhle der Waldpfoten bei (Alteractal - Süd; "..YELLOW.."[15]"..PREV.."). Sprich jedes Mal mit demselben NPC, wenn du eine neue Rufstufe erreicht hast, für ein verbessertes Abzeichen erhältst.\n\nDie Prequest ist nicht notwendig, um diese Quest zu erhalten.";
L["Quest_7161_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_7142_Location"] = "Voggah Deathgrip (Alteracgebirge; "..YELLOW.."64,60"..PREV..")";
L["Quest_7142_Note"] = "Vanndar Stormpike ist bei (Alteractal - Nord; "..YELLOW.."[B]"..PREV.."). Er muss nicht wirklich getötet werden, um die Quest zu beenden. Das Schlachtfeld muss nur auf irgendeine Art und Weise von deiner Seite gewonnen werden.\nNachdem du diese Quest abgegeben hast, sprich noch einmal mit dem NPC, um die Belohnung zu erhalten.";
L["Quest_7142_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_7123_Location"] = "Jotek (Alteractal - Süd; "..YELLOW.."[8]"..PREV..")";
L["Quest_7123_Note"] = "Rüstmeister der Frostwolf ist bei "..YELLOW.."[10]"..PREV.." und bietet mehr Quests.";
...
L["Quest_5893_Location"] = "Rüstmeister der Frostwolf (Alteractal - Süd; "..YELLOW.."[10]"..PREV..")";
L["Quest_5893_Note"] = "Die Vorräte befinden sich in der Coldtooth Mine bei (Alteractal - Süd; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_6985_Location"] = "Rüstmeister der Frostwolf (Alteractal - Süd; "..YELLOW.."[10]"..PREV..")";
L["Quest_6985_Note"] = "Die Vorräte befinden sich in der Irondeep-Mine bei (Alteractal - Nord; "..YELLOW.."[1]"..PREV..").";

L["Quest_7224_Name"] = "Beutezug im Feindesland";
L["Quest_7224_Objective"] = "Bringt 20 Rüstungsfetzen zu Schmied Regzar in Frostwolf.";
L["Quest_7224_Location"] = "Schmied Regzar (Alteractal - Süd; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7124_Location"] = "Corporal Teeka Bloodsnarl (Alteracgebirge; "..YELLOW.."66,55"..PREV..")";
L["Quest_7124_Note"] = "Um die Quest zu beenden musst Du den Morloch in der Irondeep Mine bei (Alteractal - Nord; "..YELLOW.."[1]"..PREV..") oder Zuchtmeister Schnuffel in der Coldtooth Mine bei (Alteractal - Süd; "..YELLOW.."[6]"..PREV..") die unter der Kontrolle der Allianz ist.";
...
L["Quest_7101_Location"] = "Corporal Teeka Bloodsnarl (Alteracgebirge; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7082_Location"] = "Corporal Teeka Bloodsnarl (Alteracgebirge; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7001_Location"] = "Stallmeisterin der Frostwolf (Alteractal - Süd; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7002_Location"] = "Wolfsreiterkommandant der Frostwolf (Alteractal - Süd; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_6801_Location"] = "Primalist Thurloga (Alteractal - Süd; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6825_Location"] = "Schwadronskommandant Guse (Alteractal - Süd; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6826_Location"] = "Schwadronskommandant Jeztor (Alteractal - Süd; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6827_Location"] = "Schwadronskommandant Mulverick (Alteractal - Süd; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_8105_Location"] = "Feldmarschall Oslight (Arathihochland - Die Zuflucht; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8114_Location"] = "Feldmarschall Oslight (Arathihochland - Die Zuflucht; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8115_Location"] = "Feldmarschall Oslight (Arathihochland - Die Zuflucht; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8120_Location"] = "Todesmeister Dwire (Arathihochland - Hammerfall; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8121_Location"] = "Todesmeister Dwire (Arathihochland - Hammerfall; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8122_Location"] = "Todesmeister Dwire (Arathihochland - Hammerfall; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8446_Note"] = "Quest führt Dich zu Bawahrer Remulos bei (Moonglade - Schrein von Remulos; "..YELLOW.."36,41"..PREV.."). Die Belohnung erälst Du mit der Folgequest.";
...
L["Quest_7634_Location"] = "Hastat der Uralte (Teufelswald - Der Eisenwald; "..YELLOW.."48,24"..PREV..")";
L["Quest_7634_Note"] = "Töte Azuregos um die Sehne eine ausgewachsenen blauen Drachens zu erhalten. Er wandert um die Mitte der südlichen Halbinsel in Azshara in der Nähe von "..YELLOW.."[1]"..PREV..".";
L["Quest_7634_RewardText"] = WHITE.."1";
L["Quest_7634_PreQuest"] = "Das uralte Blatt ("..YELLOW.."Geschmolzener Kern"..PREV..")";
...
L["Quest_9575_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9572_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"
...
L["Quest_9589_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9607_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_9590_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9608_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_9494_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_9492_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10884_PreQuest"] = "Die Hand von Gul'dan -> Die Litanei der Verdammnis"
L["Quest_10884_FollowQuest"] = "Die Prüfung der Naaru: Magtheridon ("..YELLOW.."Magtheridons Kammer"..PREV..")"
...
L["Quest_10670_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."77.6, 38.8"..PREV..")";
...
L["Quest_9637_Location"] = "Kalynna Lathred (Nethersturm - Area 52; "..YELLOW.."32, 63"..PREV..")";
...
L["Quest_9495_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11002_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11003_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9738_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_11972_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_AND..PREV.."3(x20)";
...
L["Quest_9763_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10885_Name"] = "Die Prüfung der Naaru: Stärke";
L["Quest_10885_Objective"] = "A'dal in Shattrath möchte, dass Ihr Kalithreshs Dreizack und Murmurs Essenz besorgt."; -- This quest is part of the attunement for Tempest Keep: The Eye
L["Quest_10885_Location"] = "A'dal (Shattrath - Terrasse des Lichts; "..YELLOW.."54.6, 44.6"..PREV..")";
L["Quest_10885_Note"] = onlyHeroic.."\nMurmur ist bei "..YELLOW.."[5]"..PREV.." im Schattenlabyrinth. Kalithreshs Dreizack findet man in der Dampfkammer bei [4].\n\nThis quest is required to enter Tempest Keep: The Eye."
L["Quest_10885_PreQuest"] = "Die Hand von Gul'dan -> Die Litanei der Verdammnis";
L["Quest_10885_FollowQuest"] = "Die Prüfung der Naaru: Magtheridon ("..YELLOW.."Magtheridons Kammer"..PREV..")"
...
L["Quest_10667_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."77.6, 38.8"..PREV..")";
L["Quest_10667_Note"] = "Hydromantin Thespia ist bei "..YELLOW.."[1]"..PREV..".\n\nDer Gegenstand droppt im normalen und heroischen Modus.";
L["Quest_10667_PreQuest"] = "Frisch von der Mechanar ("..YELLOW.."Die Mechanar"..PREV..") & Encyclopaedia Daemonica ("..YELLOW.."Schattenlabyrinth"..PREV..")";
L["Quest_10667_FollowQuest"] = "Bann der Illidari";

L["Quest_9832_Name"] = "Das zweite und das dritte Fragment";
L["Quest_9832_Objective"] = "Besorgt das zweite Schlüsselfragment aus einem arkanen Behälter im Echsenkessel und das dritte Schlüsselfragment aus einem arkanen Behälter in der Festung der Stürme. Kehrt dann zu Khadgar in Shattrath zurück.";
L["Quest_9832_Location"] = "A'dal (Shattrath - Terrasse des Lichts; "..YELLOW.."54.6, 44.6"..PREV..")";
L["Quest_9832_Note"] = "Teil der Attunement-Questreihe für Karazhan. The Arcane Container is at "..YELLOW.."[2]"..PREV..". Opening it will spawn an elemental that must be killed to get the fragment. The Second Key Fragment is in The Steamvault.";
L["Quest_9832_PreQuest"] = "Nach Karazhan ("..YELLOW.."Auch: Shadow Labyrinth"..PREV..")";
L["Quest_9832_FollowQuest"] = "The Master's Touch ("..YELLOW.."CoT: Black Morass"..PREV..")";
...
L["Quest_11371_Note"] = "One of many Daily Quests that can be available each day from this NPC.  It can be completed on any difficulty. Die Myrmidonen des Echsenkessels sind überall in der Instanz.";
...
L["Quest_11370_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11370_Note"] = dailyHeroic.."\n\nKriegsherr Kalithresh ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_9719_RewardText"] = WHITE.."1"..AQ_OR.."2";
...
L["Quest_10164_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10218_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10165_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
-- [49] Sethekk Halls (Sethekkhallen)
L["Quest_10097_Name"] = "Bruder gegen Bruder";
L["Quest_10097_Objective"] = "Tötet Dunkelwirker Syth in den Sethekkhallen und befreit Lakka. Kehrt zu Isfar außerhalb der Sethekkhallen zurück, wenn Ihr die Aufgabe abgeschlossen habt.";
L["Quest_10097_Location"] = "Isfar (Wälder von Terokkar - Auchindoun; "..YELLOW.."44,65"..PREV..")";
L["Quest_10097_Note"] = "Dunkelwirker Syth befindet sich bei "..YELLOW.."[1]"..PREV..". Im selben Raum steht auch ein Käfig, in dem Lakka sitzt. Das Öffnen des Käfigs spawnt keine Gegner.";
L["Quest_10097_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_10098_Name"] = "Terokks Erbe";
L["Quest_10098_Objective"] = "Bringt Terokks Maske, Terokks Federkiel und die Sage von Terokk zu Isfar außerhalb der Sethekkhallen.";
L["Quest_10098_Location"] = "Isfar (Wälder von Terokkar - Auchindoun; "..YELLOW.."[3]"..PREV.." auf der Eingangskarte)";
L["Quest_10098_Note"] = "Terokks Maske droppt von Dunkelwirker Syth bei "..YELLOW.."[1]"..PREV..", die Sage von Terokk findet man bei "..YELLOW.."[2]"..PREV.." und Terokks Federkiel droppt von Klauenkönig Ikiss bei "..YELLOW.."[3]"..PREV..".";
L["Quest_10098_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_11001_Name"] = "Vernichtet den Rabengott";
L["Quest_11001_Objective"] = "Tötet den Rabengott und kehrt dann zu Morthis Flügelraunen bei der Zuflucht des Cenarius zurück.";
L["Quest_11001_Location"] = "Morthis Flügelraunen (Zangarmarschen - Zuflucht des Cenarius; "..YELLOW.."80.2, 65.0"..PREV..")";
L["Quest_11001_Note"] = onlyHeroic.." This is the last quest in the Druid Swift Flight Form questline. The Raven God Anzu is summoned at "..YELLOW.."[2]"..PREV.." with materials provided by the quest giver.";
L["Quest_11001_RewardText"] = WHITE.."1";
L["Quest_11001_PreQuest"] = "Die Essenz des Adlers -> Auf der Jagd nach dem Mondstein";
...
L["Quest_11372_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11372_Note"] = dailyHeroic.."\n\nKlauenkönig Ikiss ist bei "..YELLOW.."[3]"..PREV..".";
L["Quest_11372_RewardText"] = WHITE.."1(x2)";

-- [50] Shadow Labyrinth (Schattenlabyrinth)
L["Quest_10178_Name"] = "Findet Spion To'gun";
L["Quest_10178_Objective"] = "Findet Spion To'gun im Schattenlabyrinth von Auchindoun.";
L["Quest_10178_Location"] = "Spionin Grik'tha (Wälder von Terokkar - Auchindoun; "..YELLOW.."[4] auf Eingangskarte"..PREV..")";
L["Quest_10178_Note"] = "To'gun befindet sich bei "..YELLOW.."[1]"..PREV.." (wird auch auf der Minimap angezeigt).";
L["Quest_10178_FollowQuest"] = "Seeleninstrumente";

L["Quest_10091_Name"] = "Seeleninstrumente";
L["Quest_10091_Objective"] = "Stehlt 5 Seeleninstrumente und bringt sie zu Spionagemeisterin Mehlisah Hochkrone auf der Terrasse des Lichts in Shattrath.";
L["Quest_10091_Location"] = "Spion To'gun (Schattenlabyrinth; "..YELLOW.."[1]"..PREV..")";
L["Quest_10091_Note"] = "Seeleninstrumente are the dark purple orbs that can be found scattered around the instance. Spionagemeisterin Mehlisah Hochkrone ist bei "..YELLOW.."51, 45"..PREV..".";
L["Quest_10091_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_10091_PreQuest"] = "Findet Spion To'gun";
...
L["Quest_10649_Location"] = "Altruis der Leider (Nagrand; "..YELLOW.."27.2, 43.0"..PREV..")";
L["Quest_10649_Note"] = "Schwarzherz der Hetzer ist bei "..YELLOW.."[3]"..PREV..". Dies ist der letzte Teil einer Questreihe, die im Schattenmondtal bei "..YELLOW.."61.2, 29.2"..PREV.." für Aldor und bei "..YELLOW.."55.8, 58.2"..PREV.." für Seher startet.";
L["Quest_10649_PreQuest"] = "Illidans Schüler";
L["Quest_10649_FollowQuest"] = "Rückkehr zu den Aldor"..AQ_OR.."Rückkehr zu den Sehern";

L["Quest_10177_Name"] = "Ärger in Auchindoun";
L["Quest_10177_Objective"] = "Meldet Euch bei Feldkommandeur Mahfuun beim Eingang zum Schattenlabyrinth in Auchindoun in den Wäldern von Terokkar.";
L["Quest_10177_Location"] = "Spionagemeisterin Mehlisah Hochkrone (Shattrath - Terrasse des Lichts; "..YELLOW.."50.4, 45.2"..PREV..")";
L["Quest_10177_Note"] = "Feldkommandeur Mahfuun steht im Eingangsbereich der Instanz ("..YELLOW.."[4]"..PREV.." auf Eingangskarte).";
L["Quest_10177_FollowQuest"] = "Der Kodex des Blutes";

L["Quest_10094_Name"] = "Der Kodex des Blutes";
L["Quest_10094_Objective"] = "Lest den Kodex des Blutes im Schattenlabyrinth von Auchindoun.";
L["Quest_10094_Location"] = "Feldkommandeur Mahfuun (Wälder von Terokkar - Auchindoun; "..YELLOW.."[4] auf Eingangskarte"..PREV..")";
L["Quest_10094_Note"] = "Der Kodex des Blutes liegt direkt vor Großmeister Vorpil bei "..YELLOW.."[4]"..PREV..".";
L["Quest_10094_PreQuest"] = "Ärger in Auchindoun";
L["Quest_10094_FollowQuest"] = "In das Herz des Labyrinths";

L["Quest_10095_Name"] = "In das Herz des Labyrinths";
L["Quest_10095_Objective"] = "Vernichtet Murmur und informiert danach Spionagemeisterin Mehlisah Hochkrone auf der Terrasse des Lichts in Shattrath über die Geschehnisse im Schattenlabyrinth.";
L["Quest_10095_Location"] = "Der Kodex des Blutes (Schattenlabyrinth; "..YELLOW.."[4]"..PREV..")";
L["Quest_10095_Note"] = "Murmur befindet sich bei "..YELLOW.."[5]"..PREV..". Spionagemeisterin Mehlisah Hochkrone ist bei "..YELLOW.."50.4, 45.2"..PREV..".";
L["Quest_10095_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_10095_PreQuest"] = "Der Kodex des Blutes";

L["Quest_9831_Name"] = "Nach Karazhan";
L["Quest_9831_Objective"] = "Khadgar möchte, dass Ihr das Schattenlabyrinth von Auchindoun betretet und das erste Schlüsselfragment aus einem versteckten arkanen Behälter besorgt.";
L["Quest_9831_Location"] = "Khadgar (Shattrath - Terrasse des Lichts; "..YELLOW.."54, 44"..PREV..")";
L["Quest_9831_Note"] = "Teil der Questreihe zur Einstimmung für Karazhan (Attunement). Der arkane Container is next to Murmur at "..YELLOW.."[6]"..PREV..". Opening it will spawn an elemental that must be killed to get the fragment.";
L["Quest_9831_PreQuest"] = "Khadgar";
L["Quest_9831_FollowQuest"] = "Das zweite und das dritte Fragment";
...
L["Quest_10666_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."77.6, 38.8"..PREV..").";
L["Quest_10666_Note"] = "Großmeister Vorpil befindet sich bei "..YELLOW.."[4]"..PREV..". Schließt man diese Quest und 'Frisch von der Mechanar' ("..YELLOW.."FdS: Die Mechanar"..PREV..") ab, sind zwei neue Quests bei David Wayne verfügbar.\n\nDas Item droppt nicht im heroischen Modus.";
L["Quest_10666_PreQuest"] = "Zusätzliche Materialien";

L["Quest_11375_Name"] = "Gesucht: Murmurs Flüstern";
L["Quest_11375_Objective"] = "Windhändler Zhareem hat Euch darum gebeten, ihm Murmurs Flüstern zu beschaffen. Bringt es zu ihm ins untere Viertel in Shattrath, um Eure Belohnung zu erhalten.";
L["Quest_11375_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11375_Note"] = dailyHeroic.."\n\nMurmur befindet sich bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_10944_Location"] = "Seher Olum (Höhle des Schlangenschreins; "..YELLOW.."[4]"..PREV..")"
L["Quest_10944_Note"] = "Akama ist bei "..YELLOW.."58.0, 48.2"..PREV.." zu finden.\n\nDiese Quest ist Teil der Zugangsquestreihe des Schwarzen Tempels, die für die Aldor bei Anachoret Ceyla (Schattenmondtal - Altar der Sha'tar; "..YELLOW.."62.6, 28.4"..PREV..") und für die Seher bei Arkanist Thelis (Schattenmondtal - Sanktum der Sterne; "..YELLOW.."56.2, 59.6"..PREV..") startet."
L["Quest_10944_PreQuest"] = "Schrifttafeln von Baa'ri -> Akamas Versprechen"
L["Quest_10944_FollowQuest"] = "Die List der Aschenzungen ("..YELLOW.."FdS: Festung der Stürme"..PREV..")"

-- [52] The Black Morass (Der schwarze Morast)
...
L["Quest_10296_Location"] = "Andormu (Tanaris - Höhlen der Zeit; "..YELLOW.."[8] auf Eingangskarte"..PREV..")"
L["Quest_10296_Note"] = ""
L["Quest_10296_PreQuest"] = "Flucht aus Durnholde"
L["Quest_10296_FollowQuest"] = "Die Öffnung des Dunklen Portals"

L["Quest_10297_Name"] = "Die Öffnung des Dunklen Portals"
L["Quest_10297_Objective"] = "Sa'at im schwarzen Morast der Höhlen der Zeit möchte, dass Ihr Medivh verteidigt, bis er das Dunkle Portal geöffnet hat. Kehrt zu Sa'at zurück, wenn Ihr erfolgreich wart."
L["Quest_10297_Location"] = "Sa'at (Der schwarze Morast; "..BLUE.."[A]"..PREV..")"
...
L["Quest_10297_FollowQuest"] = "Held des Schwarms"

L["Quest_10298_Name"] = "Held des Schwarms"
L["Quest_10298_Objective"] = "Kehrt zum Kind, Andormu, in den Höhlen der Zeit in Tanaris zurück."
L["Quest_10298_Location"] = "Andormu (Tanaris - Höhlen der Zeit; "..YELLOW.."[8] auf Eingangskarte"..PREV..")"
L["Quest_10298_Note"] = ""
L["Quest_10298_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"
L["Quest_10298_PreQuest"] = "Die Öffnung des Dunklen Portals"

L["Quest_9836_Name"] = "Die Berührung des Meisters"
L["Quest_9836_Objective"] = "Geht in die Höhlen der Zeit und überzeugt Medivh davon, den wiederhergestellten Schlüssel des Lehrlings zu aktivieren."
L["Quest_9836_Location"] = "Khadgar (Shattrath - Terrasse des Lichts; "..YELLOW.."54, 44"..PREV..")"
L["Quest_9836_Note"] = "Man muss sich innerhalb der Instanz befinden, wenn Aeonus stirbt, um mit Medivh sprechen zu können.\n\nDiese Quest ist Teil der Questreihe zur Einstimmung (Attunement) auf Karazhan."
L["Quest_9836_PreQuest"] = "Das zweite und das dritte Fragment"
L["Quest_9836_FollowQuest"] = "Rückkehr zu Khadgar"

L["Quest_10902_Name"] = "Meister der Elixire"
L["Quest_10902_Objective"] = "Begebt Euch in den Schwarzen Morast in den Höhlen der Zeit und besorgt 10 Essenzen der Unendlichkeit von den Fürsten der Zeitenrisse und den Bewahrerinnen der Zeitenrisse. Bringt die Essenzen zusammen mit 5 Elixieren der erheblichen Verteidigung, 5 Elixieren des Meisters und 5 Elixieren der erheblichen Beweglichkeit zu Lorokeem im unteren Viertel von Shattrath."
L["Quest_10902_Location"] = "Lorokeem (Shattrath - Unteres Viertel; "..YELLOW.."46, 23"..PREV..")"
L["Quest_10902_Note"] = "Alchimie-Quest. Lorokeem roams the coordinates listed."
L["Quest_10902_PreQuest"] = "Meister der Elixire"
...
L["Quest_11382_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")"
L["Quest_11382_Note"] = dailyHeroic.."\n\nAeonus spawnt mit der letzten Welle."
L["Quest_11382_RewardText"] = "1(x2)"
...
L["Quest_11383_Location"] = "Netherpirscher Mah'duun (Shattrath - Unteres Viertel; "..YELLOW.."75.2, 37.6"..PREV..")"
L["Quest_11383_Note"] = dailyQuest
L["Quest_11383_RewardText"] = "1"

-- [53] Battle of Mount Hyjal (Hyjalgipfel)
L["Quest_10947_Name"] = "Ein Artefakt aus der Vergangenheit"
L["Quest_10947_Objective"] = "Reist zu den Höhlen der Zeit in Tanaris und verschafft Euch Zugang zur Schlacht um den Berg Hyjal. Habt Ihr dies geschafft, so bezwingt Furor Winterfrost und bringt das zeitverzerrte Phylakterium zu Akama im Schattenmondtal."
L["Quest_10947_Location"] = "Akama (Schattenmondtal - Verborgene Kammer; "..YELLOW.."58.0, 48.2"..PREV..")"
L["Quest_10947_Note"] = "Teil der Questreihe zur Einstimmung auf den Schwarzen Tempel. Furor Winterfrost ist bei "..YELLOW.."[1]"..PREV.."."
L["Quest_10947_PreQuest"] = "Die List der Aschenzungen ("..YELLOW.."FdS: Das Auge"..PREV..")"
L["Quest_10947_FollowQuest"] = "Die Seelengeisel"

-- [54] Old Hillsbrad Foothills (Vorgebirge des Alten Hügellands)
...
L["Quest_10282_Location"] = "Andormu (Tanaris - Höhlen der Zeit; "..YELLOW.."[8] auf Eingangskarte"..PREV..")"
L["Quest_10282_Note"] = "Die Vorquest, die bei dem Drachen am Eingang der Höhlen der Zeit startet, muss absolviert sein."
L["Quest_10282_PreQuest"] = "Zum Hort des Meisters -> Die Höhlen der Zeit"
L["Quest_10282_FollowQuest"] = "Tarethas Ablenkungsmanöver"

L["Quest_10283_Name"] = "Tarethas Ablenkungsmanöver"
L["Quest_10283_Objective"] = "Reist zur Burg Durnholde und platziert mit Hilfe des Bündels mit Brandbomben, das Ihr von Erozion erhalten habt, 5 Brandsätze auf den Fässern in jeder Internierungsbaracke. Sprecht mit Thrall im Kellergefängnis der Burg Durnholde, wenn Ihr die Internierungsbaracken angezündet habt."
L["Quest_10283_Location"] = "Erozion (Altes Hügelland; "..YELLOW.."[A]"..PREV..")"
L["Quest_10283_Note"] = "Thrall is at "..YELLOW.."[2]"..PREV..". Go to Southshore "..YELLOW.."[4]"..PREV.." to hear the story of Ashbringer and see some people with familiar names like Kel'Thuzad and Herod the Bully."  -- TODO: check Thrall's position
L["Quest_10283_PreQuest"] = "Das alte Hügelland"
L["Quest_10283_FollowQuest"] = "Flucht aus Durnholde"

L["Quest_10284_Name"] = "Flucht aus Durnholde"
L["Quest_10284_Objective"] = "Gebt Thrall Bescheid, wenn Ihr bereit seid. Folgt Thrall aus der Burg Durnholde und helft ihm, Taretha zu befreien und sein Schicksal zu erfüllen. Sprecht mit Erozion im Alten Hügelland, wenn Ihr diese Aufgabe erfüllt habt."
L["Quest_10284_Location"] = "Thrall (Altes Hügelland; "..YELLOW.."[2]"..PREV..")"  -- TODO: check Thrall's position
L["Quest_10284_Note"] = "Stellt sicher, dass alle die Quest annehmen, bevor jemand Thrall das Zeichen zum Aufbruch gibt. Scheinbar kann die Quest jedoch geteilt und erfolgreich abgeschlossen werden. Du hast 20 Versuche, Thrall zu retten. Danach musst du die Instanz zurücksetzen und kannst den Endboss ohne ihn nicht töten, da Thrall den letzten Schlag ausführen muss."
L["Quest_10284_PreQuest"] = "Tarethas Ablenkungsmanöver"
L["Quest_10284_FollowQuest"] = "Rückkehr zu Andormu"

L["Quest_10285_Name"] = "Rückkehr zu Andormu"
L["Quest_10285_Objective"] = "Return to the child Andormu at the Caverns of Time in the Tanaris desert."
L["Quest_10285_Location"] = "Erozion (Altes Hügelland; "..YELLOW.."Entrance"..PREV..")"
L["Quest_10285_Note"] = "Andormu is at "..YELLOW.."58,54"..PREV..". Der Abschluss dieser Quest schaltet die Instanz 'Der schwarze Morast' frei."
L["Quest_10285_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"
L["Quest_10285_PreQuest"] = "Flucht aus Durnholde"

L["Quest_12513_Name"] = "Netter Hut..."
L["Quest_12513_Objective"] = "Don Carlos hat Euch versehentlich dazu herausgefordert, sein jüngeres Ich im Alten Hügelland zu besiegen. Bringt ihm anschließend seinen Hut als Beweis. Er befindet sich in Tanaris.";
L["Quest_12513_Location"] = "Don Carlos (Tanaris; "..YELLOW.."53.8, 28.8"..PREV..")"
L["Quest_12513_Note"] = "Don Carlos' jüngeres Ich wandert auf der Hauptstraße, die von West nach Ost verläuft.";
L["Quest_12513_RewardText"] = "1"
...
L["Quest_11378_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11378_Note"] = dailyHeroic.."\n\nEpochenjäger ist bei "..YELLOW.."[3]"..PREV..".";
L["Quest_11378_RewardText"] = "1(x2)"

-- [56] Karazhan			TODO: 9840, 9843, 9844, 9860, 9630, 9638, 9639, 9640, 9645, 9680, 9631, 9637, 9644, 10901, 12616

-- [57] The Arcatraz			TODO: 10882, 10705, 10886, 9832, 11388, 11389
L["Quest_10882_Name"] = "Herold der Verdammnis";
L["Quest_10882_Objective"] = "Ihr wurdet beauftragt, zur Arkatraz in der Festung der Stürme zu reisen und Herold Horizontiss zu töten. Kehrt danach zu A'dal auf der Terrasse des Lichts in Shattrath zurück.";
L["Quest_10882_Location"] = "A'dal (Shattrath - Terrasse des Lichts; "..YELLOW.."54.6, 44.6"..PREV..")";
L["Quest_10882_Note"] = "There is a chain quest that starts from Netherpirscher Khay'ji (Nethersturm - Area 52; "..YELLOW.."32, 64"..PREV..").";
L["Quest_10882_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_10705_Location"] = "Akama (Schattenmondtal - Verborgene Kammer; "..YELLOW.."58.0, 48.2"..PREV..")";
L["Quest_10705_Note"] = "Seher Udalo ist bei "..YELLOW.."[5]"..PREV..", kurz vor dem Raum vom Endboss.\n\nDies ist ein Teil vom Schwarzen Tempel Questreihe die von Anachoret Ceyla (Schattenmondtal - Altar der Stürme; "..YELLOW.."62.4, 28.4"..PREV..") für Aldor und Arkanist Thelis (Schattenmondtal - Sanktum der Sterne; "..YELLOW.."56.2,59.4"..PREV..") für Seher startet."
L["Quest_10705_PreQuest"] = "Schrifttafeln von Baa'ri -> Akama"
L["Quest_10705_FollowQuest"] = "Ein mysteriöses Omen"

-- [58] The Botanica (Die Botanika)			TODO: 10704, 10257, 10897, 11384, 11385

-- [62] Black Temple (Der Schwarze Tempel)
L["Quest_10958_Name"] = "Sucht die Aschenzungen auf";
L["Quest_10958_Objective"] = "Sucht Akamas Todeshörige im Schwarzen Tempel.";
L["Quest_10958_Location"] = "Xi'ri (Schattenmondtal; "..YELLOW.."65.2, 44.0"..PREV..")";
L["Quest_10958_Note"] = "Der Geist von Olum ist hinter dem Eingang des Schwarzen Tempels rauf und dann links bei "..YELLOW.."[1]"..PREV..". Er teleportiert Dich zu Seher Kanai, sobald Du den Obersten Kriegsfürst Naj'entus bei "..YELLOW.."[2]"..PREV.." und Supremus bei "..YELLOW.."[3]"..PREV.." getötet hast.";
...
L["Quest_10957_Location"] = "Seher Kanai (Der Schwarze Tempel; "..YELLOW.."[5]"..PREV..")";
L["Quest_10957_Note"] = "Akamas Schemen ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10959_Location"] = "Seher Kanai (Der Schwarze Tempel; "..YELLOW.."[5]"..PREV..")"
L["Quest_10959_Note"] = "Illidan Sturmgrimm ist bei "..YELLOW.."[11]"..PREV.."."
L["Quest_10959_RewardText"] = "1"
L["Quest_10959_PreQuest"] = "Die Erlösung der Aschenzungen"

-- [63] Zul'Aman

-- [65] Skettis (from Atlas_OutdoorRaids)			TODO: 11098, 11008, 11085, 11093, 11004, 11005, 11021, 11024, 11028, 11056, 11029, 11885, 11073

-- [67] Magister's Terrace (Terrasse der Magister)
L["Quest_11488_Name"] = "Terrasse der Magister";
L["Quest_11488_Objective"] = "Exarch Larethor beim Sammelpunkt der Zerschmetterten Sonne möchte, dass Ihr die Terrasse der Magister absucht und einen Blutelfenspion namens Tyrith findet.";
L["Quest_11488_Location"] = "Exarch Larethor (Insel von Quel'Danas - Sammelpunkt der Zerschmetterten Sonne; "..YELLOW.."47.4, 30.4"..PREV..")";
L["Quest_11488_Note"] = "Tyrith befindet sich innerhalb der Instanz bei "..YELLOW.."[2]"..PREV..". Diese Questreihe schaltet den heroischen Modus für diese Instanz frei.\n\nDie Prequest ist in Shattrath entweder bei Adyen der Lichtwächter (Aldorhöhe; "..YELLOW.."35,36"..PREV..") oder bei Dathris Sonnensturm (Sehertreppe; "..YELLOW.."55,80"..PREV..") verfügbar."
L["Quest_11488_PreQuest"] = "Krise am Sonnenbrunnen"..AQ_OR.."Pflicht ruft";
L["Quest_11488_FollowQuest"] = "Der Seher der Seher";
...
L["Quest_11490_Location"] = "Tyrith (Terrasse der Magister; "..YELLOW.."[2]"..PREV..")";
L["Quest_11490_Note"] = "Die Seherkugel ist bei "..YELLOW.."[4]"..PREV..". After the 'movie' clip, Kalecgos will appear to start the next quest."
L["Quest_11490_PreQuest"] = "Terrasse der Magister";
L["Quest_11490_FollowQuest"] = "Nicht totzukriegen";

L["Quest_11492_Name"] = "Nicht totzukriegen";
L["Quest_11492_Objective"] = "Kalecgos hat Euch damit beauftragt, Kael'thas auf der Terrasse der Magister zu bezwingen. Ihr sollt Euch mit Kaels Kopf bei Larethor am Sammelpunkt der Zerschmetterten Sonne treffen.";
L["Quest_11492_Location"] = "Kalecgos (Terrasse der Magister; "..YELLOW.."[4]"..PREV..")";
L["Quest_11492_Note"] = "Prinz Kael'thas Sonnenwanderer ist bei "..YELLOW.."[6]"..PREV..". Der Abschluss dieser Quest schaltet den Schwierigkeitsgrad 'Heroisch' für die Terrasse der Magister frei.\n\nLarethor ist bei "..YELLOW.."47, 31"..PREV..".";
L["Quest_11492_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"
L["Quest_11492_PreQuest"] = "Der Seher der Seher";
...
L["Quest_11499_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11499_Note"] = dailyHeroic.."\n\nPrinz Kael'thas Sonnenwanderer befindet sich bei "..YELLOW.."[6]"..PREV..".";
L["Quest_11499_RewardText"] = "1(x2)"
...
L["Quest_13149_Location"] = "Chromie (Stratholme Past; "..YELLOW.."[1]"..PREV..")";
L["Quest_13149_Note"] = "Die Kisten findet man in der nähe der Häuser entlang des Weges nach Stratholm. Nach beendigung der Aufgabe kannst Du die Quest bei Chromi bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_13151_Location"] = "Chromie (Stratholme Past; "..YELLOW.."[2]"..PREV..")";
L["Quest_13151_Note"] = "Mal'Ganis ist bei "..YELLOW.."[5]"..PREV..". Chromie wird erscheinen nachdem Mal'Ganis besiegt worden ist.";
L["Quest_13151_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_13151_PreQuest"] = "Illusionen bannen";

L["Quest_13243_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_11252_Location"] = "Verteidiger Mordun (Heulender Fjord - Valgarde; "..YELLOW.."59.3, 48.8"..PREV..")";
L["Quest_11252_Note"] = "Ingvar der Brandschatzer ist bei "..YELLOW.."[3]"..PREV..".\n\nDie Vorquest ist optional. Die Quest bringt Dich zu Vizeadmiral Keller bei (Heulender Fjord - Valgarde; "..YELLOW.."60.4, 61.0"..PREV..").";
L["Quest_11252_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_13205_Location"] = "Verteidiger Mordun (Heulender Fjord - Valgarde; "..YELLOW.."59.3, 48.8"..PREV..")";
L["Quest_13205_Note"] = "Die Waffen der Vykul können überall in der Instant in den Waffenständern gefunden werden. Die Vorquest bekommt man von Kundschafterin Valory (Heulender Fjord - Valgarde; "..YELLOW.."56.0, 55.8"..PREV..") and is optional.";
L["Quest_13205_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11272_Location"] = "Hochexekutor Anselm (Heulender Fjord - Hafen der Vergeltung; "..YELLOW.."78.5, 31.1"..PREV..")";
L["Quest_11272_Note"] = "Prinz Keleseth ist bei "..YELLOW.."[1]"..PREV..".";
L["Quest_11272_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11262_Location"] = "Dunkelläuferin Marrah (Burg Utgarde; "..YELLOW.."[??]"..PREV..")";
L["Quest_11262_Note"] = "Dunkelläuferin Marrah befindet sich in der Instant, nähe des Eingangs.\n\nIngvar der Brandschatzer ist bei "..YELLOW.."[3]"..PREV..".\n\nDie Quest bringt Dich zurück zu Hochexekutor Anselm in (Heulender Fjord - Hafen der Vergeltung; "..YELLOW.."78.5, 31.1"..PREV..").";
L["Quest_11262_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_13206_Location"] = "Dunkelläuferin Marrah (Heulender Fjord - ??; "..YELLOW.."??,??"..PREV..")";
L["Quest_13206_Note"] = "Die Waffen der Vykul können überall in der Instant in den Waffenständern gefunden werden.\n\nDie Quest bringt Dich zu Hochexekutor Anselm in (Heulender Fjord - Hafen der Vergeltung; "..YELLOW.."78.5, 31.1"..PREV..").";
L["Quest_13206_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13131_Location"] = "Brigg Kleinkeul (Turm Utgarde; "..YELLOW.."[A]"..PREV..")";
...
L["Quest_13131_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_13132_Name"] = "Die Rache ist mein!";
L["Quest_13132_Objective"] = "Brigg im Turm Utgarde möchte, dass Ihr König Ymiron tötet.";
L["Quest_13132_Location"] = "Brigg Kleinkeul (Turm Utgarde; "..YELLOW.."[A]"..PREV..")";
L["Quest_13132_Note"] = "König Ymiron ist bei "..YELLOW.."[4]"..PREV..".";
L["Quest_13132_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";

L["Quest_13241_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13094_Location"] = "Bibliothekarin Serrah (Boreanische Tundra - Transitusschild; "..YELLOW.."33.4, 34.3"..PREV..")";
L["Quest_13094_Note"] = "Das Forschungsergebnissbuch liegt auf dem Boden in der Halle auf den Weg zum Großmagistrix Telestra bei "..YELLOW.."[6]"..PREV..".";
L["Quest_13094_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11905_Location"] = "Erzmagier Berinand (Boreanische Tundra - Transitusschild; "..YELLOW.."32.9, 34.3"..PREV..")";
L["Quest_11905_Note"] = "Benutze den interdimensionalen Refabrikator am Ende der Plattform wo Anomaluson ist, bei "..YELLOW.."[1]"..PREV..".";
L["Quest_11905_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11973_Location"] = "Raelorasz (Boreanische Tundra - Transitusschild; "..YELLOW.."33.2, 34.4"..PREV..")";
L["Quest_11973_Note"] = "Keristrasza ist bei "..YELLOW.."[4]"..PREV..".";
L["Quest_11973_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_11911_Location"] = "Erzmagier Berinand (Boreanische Tundra - Transitusschild; "..YELLOW.."32.9, 34.3"..PREV..")";
L["Quest_11911_Note"] = "Arkane Späne droppen von den kristallinen Beschützern.";
L["Quest_11911_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_11911_PreQuest"] = "Geheimnisse der Urtume";

L["Quest_13246_RewardText"] = WHITE.."1(x2)";

L["Quest_13095_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13124_Location"] = "Raelorasz (Boreanische Tundra - Transitusschild; "..YELLOW.."33.2, 34.4"..PREV..")";
L["Quest_13124_Note"] = "Belgaristrasz wird nach der Niedelgae von Drakos der Befrager erscheinen bei "..YELLOW.."[1]"..PREV..".";
L["Quest_13124_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13126_Location"] = "Belgaristrasz (Der Nexus: Das Oculus; "..YELLOW.."[1]"..PREV..")";
L["Quest_13126_Note"] = "Belgaristrasz erscheint nach dem Tode von Varos Wolkenwanderer bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_13127_Location"] = "Abbild von Belgaristrasz (Der Nexus: Das Oculus; "..YELLOW.."[2]"..PREV..")";
L["Quest_13127_Note"] = "Belgaristrasz erscheint nach dem Tode von Magierlord Urom bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_13128_Location"] = "Abbild von Belgaristrasz (Der Nexus: Das Oculus; "..YELLOW.."[3]"..PREV..")";
L["Quest_13128_Note"] = "Leywächter Eregos ist bei "..YELLOW.."[4]"..PREV..". Raelorasz ist bei (Boreanische Tundra - Transitusschild; "..YELLOW.."33.2, 34.4"..PREV..").";
L["Quest_13128_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_13128_PreQuest"] = "Magierlord Urom";

L["Quest_13240_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13384_Location"] = "Krasus (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV..")";
...
L["Quest_13384_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_13384_PreQuest"] = "Der Schlüssel der fokussierenden Iris ("..YELLOW.."Naxxramas"..PREV..")";
...
L["Quest_13385_Location"] = "Krasus (Drachenöde - Wyrmruhtemple; "..YELLOW.."59.8, 54.6"..PREV..")";
...
L["Quest_13385_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_13385_PreQuest"] = "Der heroische Schlüssel der fokussierenden Iris ("..YELLOW.."Naxxramas"..PREV..")";

L["Quest_24584_Name"] = "Malygos muss sterben!";
L["Quest_24584_Objective"] = "Tötet Malygos.";
L["Quest_24584_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24584_Note"] = "Malygos ist bei "..YELLOW.." [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24584_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_13182_Location"] = "Kilix der Entwirrer (Drachenöde - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13182_Note"] = "Die Eier der Geiselneruber sind im ersten Raum überall verteilt, beim ersten Boss, Krik'thir der Torwächter bei "..YELLOW.."[1]"..PREV..".";
L["Quest_13182_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13167_Location"] = "Kilix der Entwirrer (Drachenöde - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13167_Note"] = "Anub'arak ist bei "..YELLOW.."[3]"..PREV..".";
L["Quest_13167_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13190_Location"] = "Kilix der Entwirrer (Drachenöde - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13190_Note"] = "Diese Aufgabe kann nur auf dem Schwierigkeitsgrad Heroisch abgeschlossen werden.\n\nThe Ahn'kahet Brazier ist hinter Herald Volazj bei "..YELLOW.."[4]"..PREV..". The corpse has a 1 hour duration timer and will disappear if you leave the instance while alive.";
...
L["Quest_13204_Note"] = "Die wilden Höhlenbestien droppen das Item für die Quest im Gebiet vom Boss Amanitar, bei "..YELLOW.."[5]"..PREV..".\n\nKilix der Entwirrer ist bei (Drachenöde - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..").";
...
L["Quest_13187_Location"] = "Kilix der Entwirrer (Drachenöde - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13187_Note"] = "Die Vergessenen und Herald Volazj können gefunden werden bei "..YELLOW.."[4]"..PREV..".";
L["Quest_13187_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13207_Location"] = "Brann Bronzebart (Ulduar: Die Hallen des Steins; "..YELLOW.."[3]"..PREV..")";
L["Quest_13207_Note"] = "Folgt Brann Bronzebart in den naheliegenden Raum bei "..YELLOW.."[4]"..PREV.." und beschützt ihn vor die Mobwellen während er an der Steintafel arbeitet. Nach seinem Erfolg , kann der Tribunalkasten rechts neben der Steintafel geöffnet werden.\n\nSprecht ihn erneut an und er rennt aus dem Raum raus zu"..YELLOW.."[5]"..PREV..". Du mußt ihm nicht folgen, er wartet dort auf dich. Ist Sjonnir der Eisenformer besiegt kann Du die Quest bei Brann Bronzebart abgegeben.";
L["Quest_13207_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13108_Location"] = "König Jokkum (Die Sturmgipfel - Dun Niffelem; "..YELLOW.."65.3, 60.1"..PREV..")";
L["Quest_13108_Note"] = "Loken ist bei "..YELLOW.."[4]"..PREV..".\n\nDiese Quest bekommt man erst nach einer sehr langen Questreihe die bei Gretchen Zischelfunken beginnt (Sturmgipfel - K3; "..YELLOW.."41.1, 86.1"..PREV..").";
L["Quest_13108_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13109_Location"] = "König Jokkum (Die Sturmgipfel - Dun Niffelem; "..YELLOW.."65.3, 60.1"..PREV..")";
L["Quest_13109_Note"] = "Volkhan ist bei "..YELLOW.."[2]"..PREV..".\n\nDiese Quest bekommt man erst nach einer sehr langen Questreihe die bei Gretchen Zischelfunken beginnt (Sturmgipfel - K3; "..YELLOW.."41.1, 86.1"..PREV..").";
L["Quest_13109_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_13109_PreQuest"] = "Sie haben unsere Männer! -> Die Abrechnung";

L["Quest_13244_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";

L["Quest_13253_RewardText"] = WHITE.."1(x2)";

L["Quest_24579_Name"] = "Sartharion muss sterben!";
L["Quest_24579_Objective"] = "Tötet Sartharion.";
L["Quest_24579_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24579_Note"] = "Sartharion ist bei "..YELLOW.."[4]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24579_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_12238_Note"] = "Drakuru's Kohlenbecken ist hinter dem Propheten Tharon'ja bei "..YELLOW.."[5]"..PREV..". Ausdauermojos droppen innerhalb Drak'Tharons Feste.";
L["Quest_12238_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_12037_Location"] = "Mack Fearsen (Grizzly Hügel - Granitquell; "..YELLOW.."16.6, 48.1"..PREV..")";
L["Quest_12037_Note"] = "Kurzel ist in einem der eingesponnenen Kokons bei "..YELLOW.."[2]"..PREV..". Bekämpfe die eingesponnenen Kokons und Du wirst sie finden.";
L["Quest_12037_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_13129_Location"] = "Kurzel (Feste Drak'Tharon; "..YELLOW.."[2]"..PREV..")";
L["Quest_13129_Note"] = "Novos der Beschwörer ist bei "..YELLOW.."[3]"..PREV..". Mack Fearsen ist bei (Grizzly Hügel - Granitquell; "..YELLOW.."16.6, 48.1"..PREV..")";
L["Quest_13129_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13098_Location"] = "Chronistin Bah'Kini (Zul'Drak - Dubra'Jin; "..YELLOW.."70.0, 20.9"..PREV..")";
...
L["Quest_13098_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13096_Location"] = "Tol'mar (Zul'Drak - Dubra'Jin; "..YELLOW.."69.9, 22.8"..PREV..")";
L["Quest_13096_Note"] = "Gal'darah ist bei "..YELLOW.."[5]"..PREV..".";
L["Quest_13096_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13111_Location"] = "Chronicler Bah'Kini (Zul'Drak - Dubra'Jin; "..YELLOW.."70.0, 20.9"..PREV..")";
L["Quest_13111_Note"] = "Fragment des Kolosses der Drakkari droppt von den Drakkari Kolossen bei "..YELLOW.."[2]"..PREV..".";
L["Quest_13111_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_13158_Location"] = "Rhonin (Dalaran - Die Violette Zitadelle; "..YELLOW.."30.5, 48.4"..PREV..")";
L["Quest_13158_Note"] = "Aufseher Alturas ist bei (Dalaran - Die Violette Festung; "..YELLOW.."60.8, 62.7"..PREV..")";
...
L["Quest_13159_Location"] = "Aufseher Alturas (Dalaran - Die Violette Festung; "..YELLOW.."60.8, 62.7"..PREV..")";
L["Quest_13159_Note"] = "Cyanigosa ist bei "..YELLOW.."[6]"..PREV..".";
L["Quest_13159_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13405_Location"] = "Brigadegeneral der Allianz:\n   Tausendwinter: Tausendwinters Festung - "..YELLOW.."50.0, 14.0"..PREV.." (patroliert)\n   Shattrath: Unteres Viertel - "..YELLOW.."66.6, 34.6"..PREV.."\n   Sturmwind: Burg Sturmwind - "..YELLOW.."83.8, 35.4"..PREV.."\n   Eisenschmiede: Militär Viertel - "..YELLOW.."69.9, 89.6"..PREV.."\n   Darnassus: Terrasse der Krieger - "..YELLOW.."57.6, 34.1"..PREV.."\n   Exodar: Die Halle des Lichts - "..YELLOW.."24.6, 55.4";
...
L["Quest_13407_Location"] = "Kriegshetzer der Horde:\n   Tausendwinter: Tausendwinters Festung - "..YELLOW.."50.0, 14.0"..PREV.." (patroliert)\n   Dalaran: Sonnenhäschers Zuflucht - "..YELLOW.."58.0, 21.1"..PREV.."\n   Shattrath: Unteres Viertel - "..YELLOW.."67.0, 56.7"..PREV.."\n   Orgrimmar: Das Tal der Ehre - "..YELLOW.."79.8, 30.3"..PREV.."\n   Donnerfels: Anhöhe der Jäger - "..YELLOW.."55.8, 76.6"..PREV.."\n   Unterstadt: Das königliche Viertel - "..YELLOW.."60.7, 87.8"..PREV.."\n   Silbermond: Platz der Weltenwanderer - "..YELLOW.."97.0, 38.3";
...
L["Quest_13372_Location"] = "Schlüssel der fokussierenden Iris (droppts von Sapphiron; "..YELLOW.."Frostwyrmhöhle [1]"..PREV..")";
L["Quest_13372_Note"] = "Alexstrasza ist bei (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV.."). Die Folge der Quest öffnet die Instant Der Nexus: Auge der Ewigkeit für den normalen 10 Mann Raid.";
L["Quest_13372_RewardText"] = WHITE.."1";
L["Quest_13372_FollowQuest"] = "Entscheidung im Auge der Ewigkeit ("..YELLOW.."Auge der Ewigkeit"..PREV..")";
...
L["Quest_13375_Location"] = "Der heroische Schlüssel der fokussierenden Iris (droppt von Sapphiron; "..YELLOW.."Frostwyrmhöhle [1]"..PREV..")";
L["Quest_13375_Note"] = "Alexstrasza ist bei (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV.."). Die Folge der Quest öffnet die Instant Der Nexus: Auge der Ewigkeit für den Heroischen 25 Mann Raid.";
L["Quest_13375_RewardText"] = WHITE.."1";
L["Quest_13375_FollowQuest"] = "Entscheidung im Auge der Ewigkeit ("..YELLOW.."Auge der Ewigkeit"..PREV..")";

L["Quest_24580_Name"] = "Anub'Rekhan muss sterben!";
L["Quest_24580_Objective"] = "Tötet Anub'Rekhan.";
L["Quest_24580_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24580_Note"] = "Anub'Rekhan ist bei "..YELLOW.."Spinnenviertel [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24580_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";

L["Quest_24582_Name"] = "Instrukteur Razuvious muss sterben!";
L["Quest_24582_Objective"] = "Tötet Instrukteur Razuvious.";
L["Quest_24582_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24582_Note"] = "Instrukteur Razuvious ist bei "..YELLOW.."Militärviertel [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24582_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";

L["Quest_24581_Name"] = "Noth der Seuchenfürst muss sterben!";
L["Quest_24581_Objective"] = "Tötet Noth der Seuchenfürst.";
L["Quest_24581_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24581_Note"] = "Noth der Seuchenfürst ist bei "..YELLOW.."Seuchenviertel [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24581_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";

L["Quest_24583_Name"] = "Flickwerk muss sterben!";
L["Quest_24583_Objective"] = "Tötet Flickwerk.";
L["Quest_24583_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24583_Note"] = "Flickwerk ist bei "..YELLOW.."Konstruktviertel [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24583_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_13604_Location"] = "Datenscheibe des Archivums (droppt von der Versammlung des Eisens; "..YELLOW.."Die Vorkammer [5]"..PREV..")";
...
L["Quest_13607_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13607_Note"] = "Das himmlische Planetarium ist bei (Ulduar - Die Vorkammer; "..YELLOW.."[7]"..PREV..").\n\nNach Beendigung dieser Quest gibt Dir Ausgrabungsleiter Doren die vier Siegel Questen.";
...
L["Quest_13609_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13609_Note"] = "Hodir ist bei "..YELLOW.."Die Behüter [9]"..PREV..".  Hordir muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13610_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13610_Note"] = "Thorim ist bei "..YELLOW.."Die Behüter [10]"..PREV..".  Thorim muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13606_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13606_Note"] = "Freya ist bei "..YELLOW.."Die Behüter [11]"..PREV..".  Freya muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13611_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13611_Note"] = "Mimiron ist bei "..YELLOW.."Der Funke der Imagination [12]"..PREV..".  Mimiron muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13614_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
...
L["Quest_13614_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_13631_Location"] = "Antwortcode Alpha (droppt von Algalon der Beobachter; "..YELLOW.."Die Vorkammer [7]"..PREV..")";
L["Quest_13631_Note"] = "Nur einer aus dem Raid kann den Antwortcode nehmen. Rhonin ist in Dalaran - Die violette Zitadelle; "..YELLOW.."30.5, 48.4"..PREV..".";
L["Quest_13631_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13817_Location"] = "Datenscheibe des Archivums (droppt von der Versammlung des Eisens; "..YELLOW.."Die Vorkammer [5]"..PREV..")";
...
L["Quest_13816_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13816_Note"] = "Das himmlische Planetarium ist bei (Ulduar - Die Vorkammer; "..YELLOW.."[7]"..PREV..").\n\nNach Beendigung dieser Quest gibt Dir Ausgrabungsleiter Doren die vier Siegel Questen.";
...
L["Quest_13822_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13822_Note"] = "Hodir ist bei "..YELLOW.."Die Behüter [9]"..PREV..".  Hordir muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13823_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13823_Note"] = "Thorim ist bei "..YELLOW.."Die Behüter [10]"..PREV..".  Thorim muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13821_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13821_Note"] = "Freya ist bei "..YELLOW.."Die Behüter [11]"..PREV..".  Freya muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13824_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
L["Quest_13824_Note"] = "Mimiron ist bei "..YELLOW.."Der Funke der Imagination [12]"..PREV..".  Mimiron muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13818_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..YELLOW.."Südlich von [5]"..PREV..")";
...
L["Quest_13818_RewardText"] = WHITE.."1"..AQ_AND.."2";
...
L["Quest_13819_Location"] = "Antwortcode Alpha (droppt von Algalon der Beobachter; "..YELLOW.."Die Vorkammer [7]"..PREV..")";
L["Quest_13819_Note"] = "Nur einer aus dem Raid kann den Antwortcode nehmen. Rhonin ist in Dalaran - Die violette Zitadelle; "..YELLOW.."30.5, 48.4"..PREV..".";
L["Quest_13819_RewardText"] = WHITE.."1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_24585_Name"] = "Der Flammenleviathan muss sterben!";
L["Quest_24585_Objective"] = "Tötet Flammenleviathan.";
L["Quest_24585_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24585_Note"] = "Flammenleviathan ist bei "..YELLOW.."Die Belagerung [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24585_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24587_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24587_Note"] = "Ignis der Meister des Eisenwerks is at "..YELLOW.."Die Belagerung [3]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24587_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";

L["Quest_24586_Name"] = "Klingenschuppe muss sterben!";
L["Quest_24586_Objective"] = "Tötet Klingenschuppe.";
L["Quest_24586_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24586_Note"] = "Klingenschuppe ist bei "..YELLOW.."Die Belagerung [2]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24586_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";

L["Quest_24588_Name"] = "XT-002 Dekonstruktor muss sterben!";
L["Quest_24588_Objective"] = "Tötet XT-002 Dekonstruktor.";
L["Quest_24588_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24588_Note"] = "XT-002 Dekonstruktor ist bei "..YELLOW.."Die Belagerung [4]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24588_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24589_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24589_Note"] = "Lord Jaraxxus ist der zweite Boss.\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24589_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_14163_Location"] = "Brigadegeneral der Allianz:\n   Tausendwintersee: Tausendwinters Festung - "..YELLOW.."50.0, 14.0"..PREV.." (patroliert)\n   Dalaran: Die Silberne Enklave - "..YELLOW.."30.0, 76.1"..PREV.."\n   Shattrath: Unteres Viertel - "..YELLOW.."66.6, 34.6"..PREV.."\n   Sturmwind: Burg Sturmwind - "..YELLOW.."83.8, 35.4"..PREV.."\n   Eisenschmiede: Militär Viertel - "..YELLOW.."69.9, 89.6"..PREV.."\n   Darnassus: Terrasse der Krieger - "..YELLOW.."57.6, 34.1"..PREV.."\n   Exodar: Die Halle des Lichts - "..YELLOW.."24.6, 55.4";
...
L["Quest_24499_Location"] = "Lady Jaina Prachtmeer (Die Seelenschmiede; "..YELLOW.."Eingang"..PREV..")";
...
L["Quest_24476_Location"] = "Caladis Prunkspeer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.2, 31.3"..PREV..")";
L["Quest_24476_Note"] = "Der Schmelztiegel der Seelen  ist bei "..YELLOW.."[3]"..PREV..", am Ende der Instanz.";
L["Quest_24476_PreQuest"] = "Das Schwert neu schmieden ("..YELLOW.."Grube von Saron"..PREV..")";
L["Quest_24476_FollowQuest"] = "Die Hallen der Reflexion ("..YELLOW.."Hallen der Reflexion"..PREV..")";
...
L["Quest_24511_Location"] = "Lady Sylvanas Windläufer (Die Seelenschmiede; "..YELLOW.."Eingang"..PREV..")";
...
L["Quest_24560_Location"] = "Myralion Sonnenfeuer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.5, 31.1"..PREV..")";
L["Quest_24560_Note"] = "Der Schmelztiegel der Seelen  ist bei "..YELLOW.."[3]"..PREV..", am Ende der Instanz.";
L["Quest_24560_PreQuest"] = "Das Schwert neu schmieden ("..YELLOW.."Grube von Saron"..PREV..")";
L["Quest_24560_FollowQuest"] = "Die Hallen der Reflexion ("..YELLOW.."Hallen der Reflexion"..PREV..")";
...
L["Quest_24683_Location"] = "Lady Jaina Prachtmeer (Die Seelenschmiede; "..YELLOW.."[2]"..PREV..")";
L["Quest_24683_Note"] = "Lady Jaina Prachtmeer ist innerhalb der Instanz.";
L["Quest_24683_PreQuest"] = "Echos gequälter Seelen ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24498_Location"] = "Lady Jaina Prachtmeer (Grube von Saron; "..YELLOW.."Eingang"..PREV..")";
L["Quest_24498_Note"] = "Die Sklaven findest Du überall in der Grube. Die Quest führt dich zu Gorkun Eisenschädel bei "..YELLOW.."[1]"..PREV.." nachdem Schmiedemeister Garfrost erledgt worden ist.";
...
L["Quest_24710_Location"] = "Lady Jaina Prchtmeer (Grube von Saron; "..YELLOW.."[1]"..PREV..")";
...
L["Quest_24710_FollowQuest"] = "Frostgram ("..YELLOW.."Hallen der Reflexion"..PREV..")";
...
L["Quest_24461_Location"] = "Caladis Prunkspeer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.2, 31.3"..PREV..")";
...
L["Quest_24461_FollowQuest"] = "Die Klinge tempern ("..YELLOW.."Forge of Souls"..PREV..")";
...
L["Quest_24682_Location"] = "Lady Sylvanas Windläufer (Die Seelenschmiede; "..YELLOW.."[2]"..PREV..")";
L["Quest_24682_Note"] = "Lady Sylvanas Windläufer ist innerhalb der Instanz.";
L["Quest_24682_PreQuest"] = "Echos gequälter Seelen ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24507_Location"] = "Lady Sylvanas Windläufer (Grube von Saron; "..YELLOW.."Eingang"..PREV..")";
L["Quest_24507_Note"] = "Die Sklaven findest Du überall in der Grube. Die Quest führt dich zu Martin Victus bei "..YELLOW.."[1]"..PREV.." nachdem Schmiedemeister Garfrost erledgt worden ist.";
...
L["Quest_24712_Location"] = "Lady Sylvanas Windrunner (Grube von Saron; "..YELLOW.."[1]"..PREV..")";
...
L["Quest_24712_FollowQuest"] = "Frostgram ("..YELLOW.."Hallen der Reflexion of Reflection"..PREV..")";
...
L["Quest_24559_Location"] = "Myralion Sonnenfeuer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.5, 31.1"..PREV..")";
...
L["Quest_24559_FollowQuest"] = "Die Klinge tempern ("..YELLOW.."Forge of Souls"..PREV..")";

L["Quest_24711_Name"] = "Frostgram";
L["Quest_24711_Objective"] = "Trefft Lady Jaina Prachtmeer am Eingang zu den Hallen der Reflexion.";
L["Quest_24711_Location"] = "Lady Jaina Prachtmeer (Grube von Saron; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_24711_PreQuest"] = "Befreiung aus der Grube ("..YELLOW.."Grube von Saron"..PREV..")";
...
L["Quest_24480_Location"] = "Caladis Prunkspeer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.2, 31.3"..PREV..")";
L["Quest_24480_Note"] = "Du kannst diese Quest innerhalb der Instanz beenden.";
L["Quest_24480_PreQuest"] = "Die Klinge tempern ("..YELLOW.."Forge of Souls"..PREV..")";
...
L["Quest_24713_Location"] = "Lady Sylvanas Windläufer (Grube von Saron; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_24713_PreQuest"] = "Befreiung aus der Grube ("..YELLOW.."Grube von Saron"..PREV..")";
...
L["Quest_24561_Location"] = "Myralion Sonnenfeuer (Eiskrone - Quel'Delars Ruh; "..YELLOW.."74.5, 31.1"..PREV..")";
L["Quest_24561_Note"] = "Du kannst diese Quest innerhalb der Instanz beenden.";
L["Quest_24561_PreQuest"] = "Die Klinge tempern ("..YELLOW.."Forge of Souls"..PREV..")";
...
L["Quest_24590_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_24590_Note"] = "Lord Mark'gar ist bei "..YELLOW.." [1]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
L["Quest_24590_RewardText"] = WHITE.."1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24875_Location"] = "Spitzel Minchar (Eiskronenzitadelle; "..YELLOW.."Near [1]"..PREV..")";
...
L["Quest_24876_Location"] = "Leutnant der Himmelsbrecher (Eiskronenzitadelle; "..GREEN.."[3']"..PREV..")";
...
L["Quest_24878_Location"] = "Alchemistin Adrianna (Eiskronenzitadelle; "..GREEN.."[4']"..PREV..")";
...
L["Quest_24880_Location"] = "Valithria Traumwandler (Eiskronenzitadelle; "..YELLOW.."[11]"..PREV..")";
...
L["Quest_24545_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24743_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24547_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24749_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24756_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24757_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24548_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24549_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24748_Location"] = "Hochlord Darion Mograine (Eiskronenzitadelle; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24877_Location"] = "Leutnant der Ogrims Hammer (Eiskronenzitadelle; "..GREEN.."[3']"..PREV..")";
...
L["Quest_26012_Location"] = "Rhonin (Dalaran - Die Violette Zitadelle; "..YELLOW.."30.5, 48.4"..PREV..")";
L["Quest_26012_Note"] = "Krasus ist bei (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV..").";
...
L["Quest_26013_Location"] = "Krasus (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV..")";
L["Quest_26013_Note"] = "Wächterin des Sanktum Xerestrasza ist innerhalb des Rubin Sanktum bei dem 2. Nebenboss Baltharus der Kriegsjünger bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_26034_Location"] = "Wächterin des Sanktum Xerestrasza (Rubinsanktum; "..YELLOW.."[A] Eingang"..PREV..")";
L["Quest_26034_Note"] = "Halion ist der Hauptboss, zu finden bei "..YELLOW.."[1]"..PREV..".";
