...
local AQ_GARRISONRESOURCES = " Garnisonsressourcen"
...
L["Quest_10670_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."77.4, 38.6"..PREV..")";
...
L["Quest_10885_Note"] = onlyHeroic.." Murmur ist bei "..YELLOW.."[4]"..WHITE..". Kalithreshs Dreizack droppt in der Dampfkammer.\n\nDiese Quest wurde benötigt, um die Festung der Stürme zu betreten, ist aber nicht mehr nötig.";
...
L["Quest_11376_Location"] = "Netherpirscher Mah'duun (Shattrath - Unteres Viertel; "..YELLOW.."75.2, 37.6"..WHITE..")";
